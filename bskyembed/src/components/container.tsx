...
export function Container({
  ...
  return (
    <div
      ref={ref}
      className="w-full bg-white hover:bg-neutral-50 dark:bg-dimmedBg dark:hover:bg-dimmedBgLighten relative transition-colors max-w-[600px] min-w-[300px] flex border dark:border-slate-600 dark:text-slate-200 rounded-xl"
      onClick={() => {
        if (ref.current && href) {
