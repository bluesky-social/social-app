...
export function Container({
  ...
  return (
    <div
      ref={ref}
      className="w-full border-2 border-brand text-black relative transition-colors max-w-[600px] min-w-[300px] flex items-center dark:text-slate-200 rounded-[32px] cursor-pointer"
      onClick={() => {
        if (ref.current && href) {
