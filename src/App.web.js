...
import { prefetchAppConfig, Provider as AppConfigProvider, } from '#/state/appConfig';
...
function InnerApp() {
    ...
    return (_jsx(Alf, { theme: theme, children: _jsx(ThemeProvider, { theme: theme, children: _jsx(ContextMenuProvider, { children: _jsx(Splash, { isReady: isReady && hasCheckedReferrer, children: _jsx(VideoVolumeProvider, { children: _jsx(ActiveVideoProvider, { children: _jsx(Fragment
