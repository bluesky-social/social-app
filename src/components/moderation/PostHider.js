...
export function PostHider(_a) {
    ...
    var t = useTheme();
    var _ = useLingui()._;
    var _b = useState(false), override = _b[0], setOverride = _b[1];
    ...
    return !override ? (_jsxs(Pressable, { onPress: function () {
        ...
        }, accessibilityRole: "button", accessibilityLabel: override ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Hides the content"], ["Hides the content"])))) : _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Shows the content"], ["Shows the content"])))), accessibilityHint: "", style: [
            a.flex_row,
            a.align_center,
            a.gap_sm,
            a.py_md,
