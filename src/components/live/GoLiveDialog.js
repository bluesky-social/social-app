...
import { displayDuration, getLiveServiceNames, useDebouncedValue, } from '#/components/live/utils';
...
function DialogInner(_a) {
    ...
    var allowedServices = getLiveServiceNames(liveNowConfig.allowedDomains).formatted;
