...
export function LikedByList(_a) {
    var _this = this;
    var uri = _a.uri;
    var _ = useLingui()._;
    var initialNumToRender = useInitialNumToRender();
    var _b = React.useState(false), isPTRing = _b[0], setIsPTRing = _b[1];
    var _c = useResolveUriQuery(uri), resolvedUri = _c.data, resolveError = _c.error, isUriLoading = _c.isLoading;
    var _d = useLikedByQuery(resolvedUri === null || resolvedUri === void 0 ? void 0 : resolvedUri.uri), data = _d.data, isLikedByLoading = _d.isLoading, isFetchingNextPage = _d.isFetchingNextPage, hasNextPage = _d.hasNextPage, fetchNextPage = _d.fetchNextPage, likedByError = _d.error, refetch = _d.refetch;
    var error = resolveError || likedByError;
    var isError = !!resolveError || !!likedByError;
