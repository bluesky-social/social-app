...
export function VideoEmbed(_a) {
    ...
    var t = useTheme();
    var ref = useRef(null);
    var _b = useActiveVideoWeb(), activeFromContext = _b.active, setActive = _b.setActive, sendPosition = _b.sendPosition, currentActiveView = _b.currentActiveView;
    ...
    var active = isGif || activeFromContext;
    useEffect(function () {
        if (!ref.current)
            return;
    ...
    return (_jsx(View, { style: [a.pt_xs], children: _jsx(ViewportObserver, { sendPosition: isGif ? noop : sendPosition, isAnyViewActive: currentActiveView !== null, children: _jsxs(ConstrainedImage, { fullBleed: true, aspectRatio: constrained || 1, 
