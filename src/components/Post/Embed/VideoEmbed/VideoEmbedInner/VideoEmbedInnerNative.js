...
export function VideoEmbedInnerNative(_a) {
    ...
    return (_jsxs(View, { style: [a.flex_1, a.relative], children: [_jsx(BlueskyVideoView, { url: embed.playlist, autoplay: !autoplayDisabled && !isWithinMessage, beginMuted: autoplayDisabled ? false : muted, style: [a.rounded_sm], onActiveChange: function (e) {
                ...
                }, ref: videoRef, accessibilityLabel: embed.alt ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Video: ", ""], ["Video: ", ""])), embed.alt)) : _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Video"], ["Video"])))), accessibilityHint: "" }), _jsx(VideoControls, { enterFullscreen: function () {
                    var _a;
