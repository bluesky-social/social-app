...
export function Controls(_a) {
    var videoRef = _a.videoRef, hlsRef = _a.hlsRef, active = _a.active, setActive = _a.setActive, focused = _a.focused, setFocused = _a.setFocused, onScreen = _a.onScreen, fullscreenRef = _a.fullscreenRef, hlsLoading = _a.hlsLoading, hasSubtitleTrack = _a.hasSubtitleTrack, isGif = _a.isGif, altText = _a.altText;
    ...
    if (isGif) {
        return (_jsx(GifPresentationControls, { isPlaying: playing, isLoading: showSpinner, onPress: onPressPlayPause, altText: altText }));
    }
    return (_jsxs("div", { style: {
            ...
            setInteractingViaKeypress(false);
                    ...
                    ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Unmute video"], ["Unmute video"]))))
                    : playing
                        ? _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Pause video"], ["Pause video"]))))
                        : _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Play video"], ["Play video"])))), accessibilityHint: "", style: [
                    a.flex_1,
