...
function InnerWrapper(_a) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(VideoEmbedInnerNative, { embed: embed, setStatus: setStatus, setIsLoading: setIsLoading, setIsActive: setIsActive, ref: ref }), _jsx(ImageBackground, { source: { uri: embed.thumbnail }, accessibilityIgnoresInvertColors: true, style: [
                ...
                , children: showOverlay &&
                    (embed.presentation === 'gif' ? (_jsx(GifPresentationControls, { isPlaying: false, isLoading: showSpinner, onPress: function () {
                            var _a;
                            (_a = ref.current) === null || _a === void 0 ? void 0 : _a.togglePlayback();
                        }, altText: embed.alt })) : (_jsx(Button, { style: [a.flex_1, a.align_center, a.justify_center], onPress: function () {
                            var _a;
                            (_a = ref.current) === null || _a === void 0 ? void 0 : _a.togglePlayback();
                        }, label: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Play video"], ["Play video"])))), children: showSpinner ? (_jsx(View, { style: [a.align_center, a.justify_center], children: _jsx(ActivityIndicator, { size: "large", color: "white" }) })) : (_jsx(PlayButtonIcon, {})) }))) })] }));
}
