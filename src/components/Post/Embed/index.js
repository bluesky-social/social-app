...
export function QuoteEmbed(_a) {
    var embed = _a.embed, onOpen = _a.onOpen, style = _a.style, linkDisabled = _a.linkDisabled, parentIsWithinQuote = _a.isWithinQuote, parentAllowNestedQuotes = _a.allowNestedQuotes;
    ...
    var contents = (_jsxs(_Fragment, { children: [_jsx(PostMeta, { author: quote.author, moderation: moderation, showAvatar: true, postHref: itemHref, timestamp: quote.indexedAt, linkDisabled: true }), moderation ? (_jsx(PostAlerts, { modui: moderation.ui('contentView'), style: [a.py_xs] })) : null, richText ? (_jsx(RichText, { value: richText, style: a.text_md, numberOfLines: 20, disableLinks: true })) : null, quote.embed && (_jsx(Embed, { embed: quote.embed, moderation: moderation, isWithinQuote: parentIsWithinQuote !== null && parentIsWithinQuote !== void 0 ? parentIsWithinQuote : true, 
                // already within quote? override nested
                allowNestedQuotes: parentIsWithinQuote ? false : parentAllowNestedQuotes }))] }));
    return (_jsx(View, { style: [a.mt_sm], onPointerEnter: linkDisabled ? undefined : onPointerEnter, onPointerLeave: linkDisabled ? undefined : onPointerLeave, children: _jsx(ContentHider, { modui: moderation === null || moderation === void 0 ? void 0 : moderation.ui('contentList'), style: [a.rounded_md, a.border, t.atoms.border_contrast_low, style], activeStyle: [a.p_md, a.pt_sm], childContainerStyle: [a.pt_sm], children: function (_a) {
                var active = _a.active;
                return (_jsxs(_Fragment, { children: [!active && !linkDisabled && (_jsx(SubtleHover, { native: true, hover: hover || pressed, style: [a.rounded_md] })), linkDisabled ? (_jsx(View, { style: [!active && a.p_md], pointerEvents: "none", children: contents })) : (_jsx(Link, { style: [!active && a.p_md], hoverStyle: t.atoms.border_contrast_high, href: itemHref, title: itemTitle, onBeforePress: onBeforePress, onPressIn: onPressIn, onPressOut: onPressOut, children: contents }))] }));
            } }) }));
}
