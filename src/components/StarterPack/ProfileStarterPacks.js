...
export function ProfileStarterPacks(_a) {
    ...
    var EmptyComponent = useCallback(function () {
        if (emptyStateMessage || emptyStateButton || emptyStateIcon) {
            return (_jsx(View, { style: [a.px_lg, a.align_center, a.justify_center], children: _jsx(EmptyState, { icon: emptyStateIcon, iconSize: "3xl", message: emptyStateMessage !== null && emptyStateMessage !== void 0 ? emptyStateMessage : _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Starter packs let you share your favorite feeds and people with your friends."], ["Starter packs let you share your favorite feeds and people with your friends."])))), button: emptyStateButton }) }));
        }
        return _jsx(Empty, {});
...
function Empty() {
    ...
    return (_jsxs(LinearGradientBackground, { style: [
        ...
        ], children: [_jsxs(View, { style: [a.gap_xs], children: [_jsx(Text, { style: [a.font_semi_bold, a.text_lg, { color: 'white' }], children: _jsx(Trans, { children: "You haven't created a starter pack yet!" }) }), _jsx(Text, { style: [a.text_md, { color: 'white' }], children: _jsx(Trans, { children: "Starter packs let you easily share your favorite feeds and people with your friends." }) })] }), _jsxs(View, { style: [a.flex_row, a.gap_md, { marginLeft: 'auto' }], children: [_jsxs(Button, { label: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Create a starter pack for me"], ["Create a starter pack for me"])))), variant: "ghost", color: "primary", size: "small", disabled: isGenerating, onPress: wrappedOpenConfirmDialog, style: { backgroundColor: 'transparent' }, children: [_jsx(ButtonText, { style: { color: 'white' }, children: _jsx(Trans, { children: "Make one for me" }) }), isGenerating && _jsx(Loader, { size: "md" })] }), _jsx(Button, { label: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Create a starter pack"], ["Create a starter pack"])))), variant: "ghost", color: "primary", size: "small", disabled: isGenerating, onPress: wrappedNavToWizard, style: {
                            backgroundColor: 'white',
                            borderColor: 'white',
                            width: 100,
                        }, hoverStyle: [{ backgroundColor: '#dfdfdf' }], children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Create" }) }) })] }), _jsxs(Prompt.Outer, { control: confirmDialogControl, children: [_jsxs(Prompt.Content, { children: [_jsx(Prompt.TitleText, { children: _jsx(Trans, { children: "Generate a starter pack" }) }), _jsx(Prompt.DescriptionText, { children: _jsx(Trans, { children: "Bluesky will choose a set of recommended accounts from people in your network." }) })] }), _jsxs(Prompt.Actions, { children: [_jsx(Prompt.Action, { color: "primary", cta: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Choose for me"], ["Choose for me"])))), onPress: generate }), _jsx(Prompt.Action, { color: "secondary", cta: _(msg(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Let me choose"], ["Let me choose"])))), onPress: function () {
                                    navigation.navigate('StarterPackWizard', {});
                                } })] })] }), _jsx(Prompt.Basic, { control: followersDialogControl, title: _(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Oops!"], ["Oops!"])))), description: _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["You must be following at least seven other people to generate a starter pack."], ["You must be following at least seven other people to generate a starter pack."])))), onConfirm: function () { }, showCancel: false }), _jsx(Prompt.Basic, { control: errorDialogControl, title: _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Oops!"], ["Oops!"])))), description: _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["An error occurred while generating your starter pack. Want to try again?"], ["An error occurred while generating your starter pack. Want to try again?"])))), onConfirm: generate, confirmButtonCta: _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Retry"], ["Retry"])))) })] }));
}
