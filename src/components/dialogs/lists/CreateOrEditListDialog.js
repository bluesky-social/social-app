...
export function CreateOrEditListDialog(_a) {
    var control = _a.control, list = _a.list, purpose = _a.purpose, onSave = _a.onSave, initialValues = _a.initialValues;
    var _ = useLingui()._;
...
function DialogInner(_a) {
    ...
    var _c = useListCreateMutation(), createListMutation = _c.mutateAsync, createListError = _c.error, isCreateListError = _c.isError, isCreatingList = _c.isPending;
    var _d = useListMetadataMutation(), updateListMutation = _d.mutateAsync, updateListError = _d.error, isUpdateListError = _d.isError, isUpdatingList = _d.isPending;
    var _e = useState(''), imageError = _e[0], setImageError = _e[1];
    var _f = useState(false), displayNameTooShort = _f[0], setDisplayNameTooShort = _f[1];
    var initialDisplayName = (list === null || list === void 0 ? void 0 : list.name) || (initialValues === null || initialValues === void 0 ? void 0 : initialValues.name) || '';
    var _g = useState(initialDisplayName), displayName = _g[0], setDisplayName = _g[1];
    var initialDescription = (list === null || list === void 0 ? void 0 : list.description) || (initialValues === null || initialValues === void 0 ? void 0 : initialValues.description) || '';
    var _h = useState(function () {
        var _a;
        var text = (_a = list === null || list === void 0 ? void 0 : list.description) !== null && _a !== void 0 ? _a : initialValues === null || initialValues === void 0 ? void 0 : initialValues.description;
        ...
        return richText;
    }), descriptionRt = _h[0], setDescriptionRt = _h[1];
    var initialAvatar = (_b = list === null || list === void 0 ? void 0 : list.avatar) !== null && _b !== void 0 ? _b : initialValues === null || initialValues === void 0 ? void 0 : initialValues.avatar;
    var _j = useState(initialAvatar), listAvatar = _j[0], setListAvatar = _j[1];
    var _k = useState(), newListAvatar = _k[0], setNewListAvatar = _k[1];
    // When creating with pre-filled values (from starter pack), consider dirty
    // immediately so the Save button is enabled
    var hasInitialValuesForCreate = !list && initialValues != null;
    var dirty = hasInitialValuesForCreate ||
