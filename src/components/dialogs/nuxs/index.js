...
import { enabled as isLiveNowBetaDialogEnabled, LiveNowBetaDialog, } from '#/components/dialogs/nuxs/LiveNowBetaDialog';
...
function Inner(_a) {
    ...
    return (_jsx(Context.Provider, { value: ctx, children: activeNux === Nux.LiveNowBetaDialog && _jsx(LiveNowBetaDialog, {}) }));
}
