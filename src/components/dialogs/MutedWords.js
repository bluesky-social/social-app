...
function MutedWordRow(_a) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx(Prompt.Basic, { control: control, title: _(msg(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Are you sure?"], ["Are you sure?"])))), description: _(msg(templateObject_16 || (templateObject_16 = __makeTemplateObject(["This will delete \"", "\" from your muted words. You can always add it back later."], ["This will delete \"", "\" from your muted words. You can always add it back later."])), word.value)), onConfirm: remove, confirmButtonCta: _(msg(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Remove"], ["Remove"])))), confirmButtonColor: "negative" }), _jsxs(View, { style: [
                    ...
                    style,
                                    ...
                                    ], children: word.targets.find(function (t) { return t === 'content'; }) ? (_jsxs(Trans, { comment: "Pattern: {wordValue} in text, tags", children: [word.value, ' ', _jsxs(Text, { style: [a.font_normal, t.atoms.text_contrast_medium], children: ["in", ' ', _jsx(Text, { style: [a.font_semi_bold, t.atoms.text_contrast_medium], children: "text & tags" })] })] })) : (_jsxs(Trans, { comment: "Pattern: {wordValue} in tags", children: [word.value, ' ', _jsxs(Text, { style: [a.font_normal, t.atoms.text_contrast_medium], children: ["in", ' ', _jsx(Text, { style: [a.font_semi_bold, t.atoms.text_contrast_medium], children: "tags" })] })] })) }) }), (expiryDate || word.actorTarget === 'exclude-following') && (_jsx(View, { style: [a.flex_1, a.flex_row, a.align_center, a.gap_sm], children: _jsxs(Text, { style: [
                                        a.flex_1,
                                        a.text_xs,
                                        a.leading_snug,
                                        t.atoms.text_contrast_medium,
                                                        ...
                                                        addSuffix: true,
                                                    })] })) })), word.actorTarget === 'exclude-following' && (_jsxs(_Fragment, { children: [' • ', _jsx(Trans, { children: "Excludes users you follow" })] }))] }) }))] }), _jsx(Button, { label: _(msg(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Remove mute word from your list"], ["Remove mute word from your list"])))), size: "tiny", shape: "round", variant: "outline", color: "secondary", onPress: function () { return control.open(); }, style: [a.ml_sm], children: _jsx(ButtonIcon, { icon: isPending ? Loader : X }) })] })] }));
}
