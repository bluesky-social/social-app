...
export var accountEmailStateQueryKey = ['accountEmailState'];
export function useAccountEmailState() {
    var _this = this;
    var _a;
    var agent = useAgent();
    var partialRefreshSession = useSessionApi().partialRefreshSession;
    var _b = useState(!!((_a = agent.session) === null || _a === void 0 ? void 0 : _a.emailConfirmed)), prevIsEmailVerified = _b[0], setPrevEmailIsVerified = _b[1];
    var state = useMemo(function () {
        var _a, _b;
        return ({
            isEmailVerified: !!((_a = agent.session) === null || _a === void 0 ? void 0 : _a.emailConfirmed),
            email2FAEnabled: !!((_b = agent.session) === null || _b === void 0 ? void 0 : _b.emailAuthFactor),
        });
    }, [agent.session]);
    /**
    ...
    useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, partialRefreshSession()];
                    case 1:
                        _a.sent();
