...
export function TokenField(_a) {
    ...
    return (_jsx(View, { children: _jsxs(TextField.Root, { children: [_jsx(TextField.Icon, { icon: Shield }), _jsx(TextField.Input, { isInvalid: isInvalid, label: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Confirmation code"], ["Confirmation code"])))), placeholder: "XXXXX-XXXXX", value: value, onChangeText: handleOnChangeText, onSubmitEditing: onSubmitEditing })] }) }));
}
