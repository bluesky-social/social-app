...
function DeviceLocationRequestDialogInner(_a) {
    ...
    return (_jsxs(View, { style: [a.gap_md], children: [_jsx(Text, { style: [a.text_xl, a.font_bold], children: _jsx(Trans, { children: "Confirm your location" }) }), _jsx(View, { style: [a.gap_sm, a.pb_xs], children: _jsx(Text, { style: [a.text_md, a.leading_snug, t.atoms.text_contrast_medium], children: _jsx(Trans, { children: "Tap below to allow Bluesky to access your GPS location. We will then use that data to more accurately determine the content and features available in your region." }) }) }), error && (_jsx(View, { style: [a.pb_xs], children: _jsx(Admonition, { type: "error", children: error }) })), _jsxs(View, { style: [a.gap_sm], children: [!dialogDisabled && (_jsxs(Button, { disabled: isRequesting, label: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Allow location access"], ["Allow location access"])))), onPress: onPressConfirm, size: IS_WEB ? 'small' : 'large', color: "primary", children: [_jsx(ButtonIcon, { icon: isRequesting ? Loader : LocationIcon }), _jsx(ButtonText, { children: _jsx(Trans, { children: "Allow location access" }) })] })), !IS_WEB && (_jsx(Button, { label: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Cancel"], ["Cancel"])))), onPress: function () { return close(); }, size: IS_WEB ? 'small' : 'large', color: "secondary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Cancel" }) }) }))] })] }));
}
