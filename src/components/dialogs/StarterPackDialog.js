...
function StarterPackList(_a) {
    ...
    var _ = useLingui()._;
    var subject = useProfileQuery({ did: targetDid }).data;
    ...
    var renderItem = useCallback(function (_a) {
        var item = _a.item;
        return (_jsx(StarterPackItem, { starterPackWithMembership: item, targetDid: targetDid, subject: subject }));
    }, [targetDid, subject]);
    ...
    return (_jsx(Dialog.InnerFlatList, { data: isLoading ? [{}] : membershipItems, renderItem: isLoading
            ...
            : function (item) { return item.starterPack.uri; }, onEndReached: onEndReached, onEndReachedThreshold: 0.1, ListHeaderComponent: listHeader, ListEmptyComponent: _jsx(Empty, { onStartWizard: onStartWizard }), style: platform({
...
function StarterPackItem(_a) {
    var _b, _c;
    var starterPackWithMembership = _a.starterPackWithMembership, targetDid = _a.targetDid, subject = _a.subject;
    var t = useTheme();
    var ax = useAnalytics();
    var _ = useLingui()._;
    var starterPack = starterPackWithMembership.starterPack;
    var isInPack = !!starterPackWithMembership.listItem;
    var _d = useListMembershipAddMutation({
        subject: subject,
        onSuccess: function () {
        ...
        onError: function (err) {
            ...
            Toast.show(_(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Failed to add to starter pack"], ["Failed to add to starter pack"])))), { type: 'error' });
        },
    }), addMembership = _d.mutate, isPendingAdd = _d.isPending;
    var _e = useListMembershipRemoveMutation({
        onSuccess: function () {
        ...
        onError: function (err) {
            ...
            Toast.show(_(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Failed to remove from starter pack"], ["Failed to remove from starter pack"])))), { type: 'error' });
        },
    }), removeMembership = _e.mutate, isPendingRemove = _e.isPending;
    var isPending = isPendingAdd || isPendingRemove;
    var handleToggleMembership = function () {
        var _a, _b;
        if (!((_a = starterPack.list) === null || _a === void 0 ? void 0 : _a.uri) || isPending)
            return;
    ...
    return (_jsxs(View, { style: [a.flex_row, a.justify_between, a.align_center, a.py_md], children: [_jsxs(View, { children: [_jsx(Text, { emoji: true, style: [a.text_md, a.font_semi_bold], numberOfLines: 1, children: record.name }), _jsx(View, { style: [a.flex_row, a.align_center, a.mt_xs], children: starterPack.listItemsSample &&
                            starterPack.listItemsSample.length > 0 && (_jsxs(_Fragment, { children: [_jsx(AvatarStack, { size: 24, profiles: (_b = starterPack.listItemsSample) === null || _b === void 0 ? void 0 : _b.slice(0, 4).map(function (p) { return p.subject; }) }), ((_c = starterPack.list) === null || _c === void 0 ? void 0 : _c.listItemCount) &&
                                    starterPack.list.listItemCount > 4 && (_jsx(Text, { style: [
                                        a.text_sm,
                                        t.atoms.text_contrast_medium,
                                        a.ml_xs,
                                    ], children: _jsx(Trans, { children: _jsx(Plural, { value: starterPack.list.listItemCount - 4, other: "+# more" }) }) }))] })) })] }), _jsxs(Button, { label: isInPack ? _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Remove"], ["Remove"])))) : _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Add"], ["Add"])))), color: isInPack ? 'secondary' : 'primary_subtle', size: "tiny", disabled: isPending, onPress: handleToggleMembership, children: [isPending && _jsx(ButtonIcon, { icon: Loader }), _jsx(ButtonText, { children: isInPack ? _jsx(Trans, { children: "Remove" }) : _jsx(Trans, { children: "Add" }) })] })] }));
}
