...
export function LinkWarningDialog() {
    ...
    return (_jsxs(Dialog.Outer, { control: linkWarningDialogControl.control, nativeOptions: { preventExpansion: true }, webOptions: { alignCenter: true }, onClose: linkWarningDialogControl.clear, children: [_jsx(Dialog.Handle, {}), _jsx(LinkWarningDialogInner, { link: linkWarningDialogControl.value })] }));
}
export function CustomLinkWarningDialog(_a) {
    var control = _a.control, link = _a.link;
    return (_jsxs(Dialog.Outer, { control: control, nativeOptions: { preventExpansion: true }, children: [_jsx(Dialog.Handle, {}), _jsx(LinkWarningDialogInner, { link: link })] }));
}
function LinkWarningDialogInner(_a) {
    var _b;
    var link = _a.link;
