...
const Pause_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
const Pause_Stroke2_Corner2_Rounded = createSinglePathSVG({
...
const Pause_Filled_Corner2_Rounded = createSinglePathSVG({
