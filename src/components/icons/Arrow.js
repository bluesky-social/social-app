...
export var ArrowTopRight_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowTop_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowLeft_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowRight_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowBottom_Stroke2_Corner0_Rounded = createSinglePathSVG({
