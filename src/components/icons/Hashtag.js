...
export var HashtagWide_Stroke1_Corner0_Rounded = createSinglePathSVG({
    viewBox: '0 0 46 46',
    strokeLinecap: 'round',
...
export var Hashtag_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var Hashtag_Filled_Corner0_Rounded = createSinglePathSVG({
