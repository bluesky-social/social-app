...
export var Home_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var Home_Stroke2_Corner2_Rounded = createSinglePathSVG({
...
export var Home_Filled_Corner0_Rounded = createSinglePathSVG({
