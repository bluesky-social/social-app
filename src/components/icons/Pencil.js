...
export var Pencil_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var PencilLine_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var PencilLine_Stroke2_Corner2_Rounded = createSinglePathSVG({
