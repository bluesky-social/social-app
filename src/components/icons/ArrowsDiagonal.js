...
export var ArrowsDiagonalOut_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowsDiagonalIn_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowsDiagonalOut_Stroke2_Corner2_Rounded = createSinglePathSVG({
...
export var ArrowsDiagonalIn_Stroke2_Corner2_Rounded = createSinglePathSVG({
