...
export var BubbleQuestion_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var Bubble_Stroke2_Corner2_Rounded = createSinglePathSVG({
...
export var Bubble_Stroke2_Corner3_Rounded = createSinglePathSVG({
...
export var Bubbles_Stroke2_Corner2_Rounded = createSinglePathSVG({
