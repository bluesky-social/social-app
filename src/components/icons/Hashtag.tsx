...
export const HashtagWide_Stroke1_Corner0_Rounded = createSinglePathSVG({
  path: 'M23.833 10a1 1 0 0 1 1.116.868l.36 4.132h5.985l.36-4.132a1 1 0 1 1 1.985.248l-.36 4.132H54.5a1 1 0 1 1 0 2h-2.617l-4.5 44H54.5a1 1 0 1 1 0 2h-3.617l-.36 4.132a1 1 0 1 1-1.985-.248l.36-4.132H18.882l-.36 4.132a1 1 0 1 1-1.985-.248l.36-4.132H10.5a1 1 0 1 1 0-2h2.617l4.5-44H10.5a1 1 0 1 1 0-2h3.617l.36-4.132a1 1 0 0 1 1.117-.868ZM18.883 20.667l4.5 44h5.984l-4.5-44h-5.984Z',
  viewBox: '0 0 65 64',
})
