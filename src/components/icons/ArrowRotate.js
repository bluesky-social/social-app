...
export var ArrowRotateCounterClockwise_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var ArrowRotateClockwise_Stroke2_Corner0_Rounded = createSinglePathSVG({
