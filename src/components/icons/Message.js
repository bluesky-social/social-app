...
export var Message_Stroke1_Corner0_Rounded_Filled = createSinglePathSVG({
    viewBox: '0 0 51 51',
    strokeWidth: 2,
...
export var Message_Stroke2_Corner0_Rounded_Filled = createSinglePathSVG({
...
export var Message_Stroke2_Corner0_Rounded = createSinglePathSVG({
