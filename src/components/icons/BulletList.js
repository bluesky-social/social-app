...
export var BulletList_Stroke1_Corner0_Rounded = createSinglePathSVG({
    viewBox: '0 0 47 38',
    strokeLinecap: 'round',
...
export var BulletList_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var BulletList_Filled_Corner0_Rounded = createSinglePathSVG({
