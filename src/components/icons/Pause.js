...
export var Pause_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var Pause_Filled_Corner0_Rounded = createSinglePathSVG({
...
export var Pause_Stroke2_Corner2_Rounded = createSinglePathSVG({
...
export var Pause_Filled_Corner2_Rounded = createSinglePathSVG({
