...
export var MagnifyingGlass_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var MagnifyingGlass_Filled_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var MagnifyingGlassX_Stroke2_Corner0_Rounded = createSinglePathSVG({
...
export var MagnifyingGlassX_Stroke2_Corner0_Rounded_Large = createSinglePathSVG({
    viewBox: '0 0 64 64',
