    ...
    <Pressable
      ...
      onPress={e => {
        if (IS_ANDROID) {
           ...
           * {@link http://192.168.0.49:8085/repository/github/bluesky-social/social-app/pull/5849/files#diff-de516ef5e7bd9840cd639213301df38cf03acfcad5bda85a1d63efd249ba79deL124-L127}
           */
          context.control.close(() => {
            onPress?.(e)
          })
