...
function DialogInner(_a) {
    ...
    var items = useMemo(function () {
        ...
        if (hasSearchText &&
            ...
            _items.push({ type: 'empty', key: 'empty', message: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["No results"], ["No results"])))) });
        }
        return _items;
    }, [
        _,
    ...
    var onViewableItemsChanged = useNonReactiveCallback(function (_a) {
            ...
            if (item.type === 'profile') {
                if (!seenProfilesRef.current.has(item.profile.did)) {
                    ...
                    ax.metric('suggestedUser:seen', {
                        ...
                        recId: hasSearchText ? undefined : suggestions === null || suggestions === void 0 ? void 0 : suggestions.recId,
    ...
    var viewabilityConfig = useMemo(function () { return ({
