    ...
    return (_jsxs(Menu.Root, { children: [_jsx(Menu.Trigger, { label: label, hint: hint, children: function (_a) {
                    ...
                    return (_jsx(InlineLinkText, __assign({ to: {
                            ...
                            if (IS_WEB) {
                                ...
                                }, children: [_jsx(Menu.ItemText, { children: isCashtag ? (_jsxs(Trans, { children: ["See ", tag, " posts by user"] })) : (_jsxs(Trans, { children: ["See #", tag, " posts by user"] })) }), _jsx(Menu.ItemIcon, { icon: Person })] }))] }), _jsx(Menu.Divider, {}), _jsxs(Menu.Item, { label: isMuted ? _(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Unmute ", ""], ["Unmute ", ""])), tag)) : _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Mute ", ""], ["Mute ", ""])), tag)), onPress: function () {
                            if (isMuted) {
                                resetUpsert();
                        ...
                        }, children: [_jsx(Menu.ItemText, { children: isMuted ? _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Unmute ", ""], ["Unmute ", ""])), tag)) : _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Mute ", ""], ["Mute ", ""])), tag)) }), _jsx(Menu.ItemIcon, { icon: isPreferencesLoading ? Loader : Mute })] })] })] }));
}
