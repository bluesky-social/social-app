...
export function show(content, _a) {
    ...
    if (typeof content === 'string') {
        sonner(_jsx(ToastConfigProvider, { id: id, type: type, children: _jsxs(ToastOuter, { children: [_jsx(ToastIcon, {}), _jsx(ToastText, { children: content })] }) }), __assign(__assign({}, options), { unstyled: true, // required on web
            id: id, duration: (_b = options === null || options === void 0 ? void 0 : options.duration) !== null && _b !== void 0 ? _b : DURATION }));
    }
    else if (React.isValidElement(content)) {
        sonner(_jsx(ToastConfigProvider, { id: id, type: type, children: content }), __assign(__assign({}, options), { unstyled: true, // required on web
            id: id, duration: (_c = options === null || options === void 0 ? void 0 : options.duration) !== null && _c !== void 0 ? _c : DURATION }));
    }
    else {
