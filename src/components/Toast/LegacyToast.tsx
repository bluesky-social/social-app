...
import {IconName, ToastIcon} from './ToastIcon'

const TIMEOUT = 2e3

/**
 * NOTE: This is the JS version of the toast component, used for android
 */

export function show(message: string, icon: IconName = 'check') {
