        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    logger.error("Failed to ".concat(action, " quote"), { safeMessage: e.message });
                    return [3 /*break*/, 4];
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (e instanceof MaxHiddenRepliesError) {
                        Toast.show(_(plural(MAX_HIDDEN_REPLIES, {
                        ...
                        logger.error("Failed to ".concat(action, " reply"), { safeMessage: e.message });
                    }
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if ((e === null || e === void 0 ? void 0 : e.name) !== 'AbortError') {
                        ...
                        Toast.show(_(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["There was an issue! ", ""], ["There was an issue! ", ""])), e.toString())), 'xmark');
                    }
                    return [3 /*break*/, 3];
            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    if ((e === null || e === void 0 ? void 0 : e.name) !== 'AbortError') {
                        ...
                        Toast.show(_(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["There was an issue! ", ""], ["There was an issue! ", ""])), e.toString())), 'xmark');
                    }
                    return [3 /*break*/, 4];
                ...
                case 7:
                    ...
                    if ((e === null || e === void 0 ? void 0 : e.name) !== 'AbortError') {
                        ...
                        Toast.show(_(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["There was an issue! ", ""], ["There was an issue! ", ""])), e.toString())), 'xmark');
                    }
                    return [3 /*break*/, 8];
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(Menu.Outer, { children: [isAuthor && (_jsxs(_Fragment, { children: [_jsx(Menu.Group, { children: _jsxs(Menu.Item, { testID: "pinPostBtn", label: isPinned
                        ...
                        (canHideReplyForEveryone || canDetachQuote || canHidePostForMe) && (_jsxs(_Fragment, { children: [_jsx(Menu.Divider, {}), _jsxs(Menu.Group, { children: [canHidePostForMe && (_jsxs(Menu.Item, { testID: "postDropdownHideBtn", label: isReply
                                            ...
                                            : function () { return quotePostDetachConfirmControl.open(); }, children: [_jsx(Menu.ItemText, { children: quoteEmbed.isDetached
                                                    ...
                                                    : _(msg(templateObject_47 || (templateObject_47 = __makeTemplateObject(["Mute account"], ["Mute account"])))), onPress: function () { return void onMuteAuthor(); }, children: [_jsx(Menu.ItemText, { children: ((_g = postAuthor.viewer) === null || _g === void 0 ? void 0 : _g.muted)
