...
export function Embed(_a) {
    ...
    if (e.type === 'images') {
        ...
        return (_jsx(Outer, { style: style, children: e.view.presentation === 'gif' ? (_jsx(GifItem, { thumbnail: e.view.thumbnail, alt: e.view.alt })) : (_jsx(VideoItem, { thumbnail: e.view.thumbnail, alt: e.view.alt })) }));
    }
...
export function ImageItem(_a) {
    ...
    if (!thumbnail) {
        return (_jsx(View, { style: [
                ...
                { maxWidth: 100 },
                a.rounded_xs,
            ], accessibilityLabel: alt, accessibilityHint: "", children: children }));
    }
