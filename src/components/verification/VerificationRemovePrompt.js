...
export function VerificationRemovePrompt(_a) {
    var _this = this;
    var control = _a.control, profile = _a.profile, verifications = _a.verifications, onConfirmInner = _a.onConfirm;
    var _ = useLingui()._;
    var remove = useVerificationsRemoveMutation().mutateAsync;
    var onConfirm = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onConfirmInner === null || onConfirmInner === void 0 ? void 0 : onConfirmInner();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, remove({ profile: profile, verifications: verifications })];
                case 2:
                    _a.sent();
                    Toast.show(_(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Removed verification"], ["Removed verification"])))));
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    Toast.show(_(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Failed to remove verification"], ["Failed to remove verification"])))), 'xmark');
