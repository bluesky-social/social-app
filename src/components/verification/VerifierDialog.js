...
export function VerifierDialog(_a) {
    ...
    return (_jsxs(Dialog.Outer, { control: control, nativeOptions: { preventExpansion: true }, children: [_jsx(Dialog.Handle, {}), _jsx(Inner, { control: control, profile: profile, verificationState: verificationState }), _jsx(Dialog.Close, {})] }));
}
function Inner(_a) {
    ...
    return (_jsx(Dialog.ScrollableInner, { label: label, style: [
            gtMobile ? { width: 'auto', maxWidth: 400, minWidth: 200 } : a.w_full,
                        ...
                        gtMobile ? [a.flex_row, a.justify_end] : [a.flex_col],
                            ...
                            })), size: "small", color: "primary", style: [a.justify_center], onPress: function () {
                                ax.metric('verification:learn-more', {
                                    location: 'verifierDialog',
                                });
                            }, children: _jsx(ButtonText, { children: _jsx(Trans, { context: "english-only-resource", children: "Learn more" }) }) }), _jsx(Button, { label: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Close dialog"], ["Close dialog"])))), size: "small", color: "secondary", onPress: function () {
                                control.close();
