    ...
    return (_jsxs(_Fragment, { children: [_jsx(AgeAssuranceInitDialog, { control: control }), _jsx(AgeAssuranceAppealDialog, { control: appealControl }), _jsx(View, { style: style, children: _jsxs(View, { style: [a.p_lg, a.rounded_md, a.border, t.atoms.border_contrast_low], children: [_jsx(View, { style: [
                                ...
                                a.z_10,
                                                ...
                                                if (access !== aa.Access.Full) {
                                                    ...
                                                    props.setDialogError(_(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["We're sorry, but based on your device's location, you are currently located in a region that requires age assurance."], ["We're sorry, but based on your device's location, you are currently located in a region that requires age assurance."])))));
                                                }
                                                else {
                                                    props.closeDialog(function () {
                                                        // set this after close!
                                                        setDeviceGeolocation(props.geolocation);
                                                        Toast.show(_(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Thanks! You're all set."], ["Thanks! You're all set."])))), {
                                                            type: 'success',
                                                        });
                                                    });
                                                }
                                            } })] }))] }), isBlocked ? (_jsx(Admonition, { type: "warning", children: _jsxs(Trans, { children: ["You are currently unable to access Bluesky's Age Assurance flow. Please", ' ', _jsx(InlineLinkText, __assign({ label: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Contact our moderation team"], ["Contact our moderation team"])))) }, createStaticClick(function () {
                                        appealControl.open();
                                        ...
                                        gtPhone
                                            ...
                                            : [a.gap_md],
                                    ], children: [_jsx(Button, { label: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Verify now"], ["Verify now"])))), size: "small", variant: "solid", color: hasInitiated ? 'secondary' : 'primary', onPress: function () {
                                                control.open();
