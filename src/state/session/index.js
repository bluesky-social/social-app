...
export function Provider(_a) {
    ...
    var store = useState(function () { return new SessionStore(); })[0];
    var state = useSyncExternalStore(store.subscribe, store.getState);
    var onboardingDispatch = useOnboardingDispatch();
    var onAgentSessionChange = useCallback(function (agent, accountDid, sessionEvent) {
    ...
    var createAccount = useCallback(function (params, metrics) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var login = useCallback(function (params, logContext) { return __awaiter(_this, void 0, void 0, function () {
        var signal, _a, agent, account;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
    ...
    var logoutCurrentAccount = useCallback(function (logContext) {
    ...
    var logoutEveryAccount = useCallback(function (logContext) {
        addSessionDebugLog({ type: 'method:start', method: 'logout' });
        cancelPendingTask();
        var prevState = store.getState();
        store.dispatch({
        ...
        for (var _i = 0, _a = prevState.accounts; _i < _a.length; _i++) {
            var account = _a[_i];
    ...
    var resumeSession = useCallback(function (storedAccount_1) {
        var args_1 = [];
    ...
    var partialRefreshSession = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    var removeAccount = useCallback(function (account) {
        addSessionDebugLog({
            type: 'method:start',
    ...
    var stateContext = useMemo(function () { return ({
    ...
    var api = useMemo(function () { return ({
    ...
    var currentAgentRef = useRef(agent);
    useEffect(function () {
...
function useOneTaskAtATime() {
    ...
    var cancelPendingTask = useCallback(function () {
...
export function useRequireAuth() {
    ...
    return useCallback(function (fn) {
        if (hasSession) {
            fn();
        }
        else {
