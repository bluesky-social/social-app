...
var BIRTHDATE_DELAY_HOURS = IS_DEV ? 0.001 : 48;
/**
 ...
 */
export function snoozeBirthdateUpdateAllowedForDid(did) {
 ...
 * data on load.
 */
export function hasSnoozedBirthdateUpdateForDid(did) {
...
export function useIsBirthdateUpdateAllowed() {
    ...
    return useMemo(function () {
        ...
        var diffMs = Date.now() - lastUpdatedDate.getTime();
...
export function useBirthdateMutation() {
    ...
    var agent = useAgent();
    var patchOtherRequiredData = usePatchAgeAssuranceOtherRequiredData();
    return useMutation({
        mutationFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        bday = birthDate.toISOString();
                        return [4 /*yield*/, agent.setPersonalDetails({ birthDate: bday })
                            // triggers a refetch
                        ];
                    case 1:
                        _c.sent();
