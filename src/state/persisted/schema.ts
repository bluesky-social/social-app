...
const schema = z.object({
  ...
  disableLikeMetrics: z.enum(['show', 'hide-own', 'hide-all']),
  disableRepostMetrics: z.enum(['show', 'hide-own', 'hide-all']),
  disableQuoteMetrics: z.enum(['show', 'hide-own', 'hide-all']),
  disableBookmarkMetrics: z.enum(['show', 'hide-own', 'hide-all']),
  disableReplyMetrics: z.enum(['show', 'hide-own', 'hide-all']),
...
export const defaults: Schema = {
  ...
  disableLikeMetrics: 'show',
  disableRepostMetrics: 'show',
  disableQuoteMetrics: 'show',
  disableBookmarkMetrics: 'show',
  disableReplyMetrics: 'show',
  kawaii: false,
