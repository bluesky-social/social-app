...
var externalEmbedOptions = ['show', 'hide'];
/**
 ...
 */
var currentAccountSchema = accountSchema.extend({
...
export var defaults = {
    ...
    languagePrefs: {
        ...
        appLanguage: findSupportedAppLanguage([
            (_a = deviceLocales.at(0)) === null || _a === void 0 ? void 0 : _a.languageTag,
...
export function tryParse(rawData) {
    var _a, _b;
    var objData;
    try {
    ...
    var parsed = schema.safeParse(objData);
    if (parsed.success) {
        return objData;
    }
    else {
        var errors = ((_b = (_a = parsed.error) === null || _a === void 0 ? void 0 : _a.errors) === null || _b === void 0 ? void 0 : _b.map(function (e) {
            var _a;
            return ({
                code: e.code,
                // @ts-ignore exists on some types
                expected: e === null || e === void 0 ? void 0 : e.expected,
                path: (_a = e.path) === null || _a === void 0 ? void 0 : _a.join('.'),
            });
        })) || [];
        logger.error("persisted store: data failed validation on read", { errors: errors });
        return undefined;
    }
}
