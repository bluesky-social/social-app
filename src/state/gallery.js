...
import { cacheDirectory, deleteAsync, makeDirectoryAsync, moveAsync, } from 'expo-file-system/legacy';
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, moveIfNecessary(raw.path)];
                case 1: return [2 /*return*/, (_a.source = (_b.path = _c.sent(),
                        _b.width = raw.width,
