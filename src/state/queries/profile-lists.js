...
var PAGE_SIZE = 30;
export var RQKEY_ROOT = 'profile-lists';
    ...
    return useInfiniteQuery({
        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.app.bsky.graph.getLists({
                                actor: did,
                                limit: PAGE_SIZE,
                                cursor: pageParam,
                            })];
        ...
        select: function (data) {
            return __assign(__assign({}, data), { pages: data.pages.map(function (page) {
                    return __assign(__assign({}, page), { lists: page.lists.filter(function (list) {
                            var decision = moderateUserList(list, moderationOpts);
