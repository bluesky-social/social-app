...
export var RQKEY_LINK_ROOT = 'resolve-link';
export var RQKEY_LINK = function (url) { return [RQKEY_LINK_ROOT, url]; };
export var RQKEY_GIF_ROOT = 'resolve-gif';
export var RQKEY_GIF = function (url) { return [RQKEY_GIF_ROOT, url]; };
    ...
    return useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, resolveLink(agent, url)];
...
export function useResolveGifQuery(gif) {
    ...
    return useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, resolveGif(agent, gif)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); },
