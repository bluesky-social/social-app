...
var suggestedFeedsQueryKeyRoot = 'suggestedFeeds';
export var suggestedFeedsQueryKey = [suggestedFeedsQueryKeyRoot];
    ...
    return useInfiniteQuery({
        ...
        queryFn: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, agent.app.bsky.feed.getSuggestedFeeds({
                            limit: 10,
                            cursor: pageParam,
                        })];
                    case 1:
