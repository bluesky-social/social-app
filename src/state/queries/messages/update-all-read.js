...
export function useUpdateAllRead(status, _a) {
    var _this = this;
    ...
    return useMutation({
        mutationFn: function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, agent.chat.bsky.convo.updateAllRead({ status: status }, { headers: DM_SERVICE_HEADERS, encoding: 'application/json' })];
                    case 1:
                        data = (_a.sent()).data;
        ...
        onMutate: function () {
            var prevPages = [];
            queryClient.setQueryData(CONVO_LIST_KEY(status), function (old) {
                if (!old)
                    return old;
                prevPages = old.pages;
            ...
            queryClient.setQueryData(CONVO_LIST_KEY('all', 'unread'), function (old) {
                if (!old)
                    return old;
                return __assign(__assign({}, old), { pages: old.pages.map(function (page) {
                        return __assign(__assign({}, page), { convos: page.convos.filter(function (convo) { return convo.status !== status; }) });
                    }) });
            });
