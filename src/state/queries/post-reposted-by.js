...
var RQKEY_ROOT = 'post-reposted-by';
        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.getRepostedBy({
                                uri: resolvedUri || '',
                                limit: PAGE_SIZE,
                                cursor: pageParam,
                            })];
...
export function findAllProfilesInQueryData(queryClient, did) {
    var queryDatas, _i, queryDatas_1, _a, _queryKey, queryData, _b, _c, page, _d, _e, repostedBy;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                ...
                page = _c[_b];
                _d = 0, _e = page.repostedBy;
                _f.label = 3;
            case 3:
                if (!(_d < _e.length)) return [3 /*break*/, 6];
                repostedBy = _e[_d];
                if (!(repostedBy.did === did)) return [3 /*break*/, 5];
                return [4 /*yield*/, repostedBy];
            case 4:
                _f.sent();
                _f.label = 5;
            case 5:
