        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.getLikes({
                                uri: resolvedUri || '',
                                limit: PAGE_SIZE,
                                cursor: pageParam,
                            })];
...
export function findAllProfilesInQueryData(queryClient, did) {
    var queryDatas, _i, queryDatas_1, _a, _queryKey, queryData, _b, _c, page, _d, _e, like;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 3:
                ...
                like = _e[_d];
                if (!(like.actor.did === did)) return [3 /*break*/, 5];
                return [4 /*yield*/, like.actor];
            case 4:
                _f.sent();
                _f.label = 5;
            case 5:
