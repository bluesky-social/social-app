...
var RQKEY_ROOT = 'profile-follows';
export var RQKEY = function (did) { return [RQKEY_ROOT, did]; };
export function useProfileFollowsQuery(did, _a) {
    var _b = _a === void 0 ? {
        limit: PAGE_SIZE,
    } : _a, limit = _b.limit;
    var agent = useAgent();
        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.app.bsky.graph.getFollows({
                                actor: did || '',
...
export function findAllProfilesInQueryData(queryClient, did) {
    var queryDatas, _i, queryDatas_1, _a, _queryKey, queryData, _b, _c, page, _d, _e, follow;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 2:
                ...
                page = _c[_b];
                _d = 0, _e = page.follows;
                _f.label = 3;
            case 3:
                if (!(_d < _e.length)) return [3 /*break*/, 6];
                follow = _e[_d];
                if (!(follow.did === did)) return [3 /*break*/, 5];
                return [4 /*yield*/, follow];
            case 4:
                _f.sent();
                _f.label = 5;
            case 5:
