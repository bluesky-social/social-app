...
export function hydrateFeedGenerator(view) {
    ...
    return {
        ...
        displayName: view.displayName
            ...
            : "Feed by ".concat(sanitizeHandle(view.creator.handle, '@')),
...
export function hydrateList(view) {
    ...
    return {
        ...
        displayName: view.name
            ...
            : "User List by ".concat(sanitizeHandle(view.creator.handle, '@')),
...
var pinnedFeedInfosQueryKeyRoot = 'pinnedFeedsInfos';
    ...
    return useQuery({
        ...
        queryKey: [
            ...
            (hasSession ? 'authed:' : 'unauthed:') +
                pinnedItems.map(function (f) { return f.value; }).join(','),
        ],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
...
export function useSavedFeeds() {
    ...
    return useQuery({
        staleTime: STALE.INFINITY,
        enabled: !isLoadingPrefs,
        queryKey: __spreadArray([pinnedFeedInfosQueryKeyRoot], savedItems, true),
