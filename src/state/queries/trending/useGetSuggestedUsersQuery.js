...
export var createGetSuggestedUsersQueryKey = function (props) { return [
...
export function useGetSuggestedUsersQuery(props) {
    ...
    return useQuery({
        ...
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            var contentLangs, userInterests, data, fallbackData;
            var _a, _b;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, agent.app.bsky.unspecced.getSuggestedUsers({
                                ...
                                headers: __assign(__assign({}, createBskyTopicsHeader(userInterests)), { 'Accept-Language': contentLangs }),
                            })
                    ...
                    case 1:
                        ...
                        logger.error("Did not get any suggested users, falling back - interests: ".concat(userInterests));
                        return [4 /*yield*/, agent.app.bsky.unspecced.getSuggestedUsers({
