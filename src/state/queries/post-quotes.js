...
var PAGE_SIZE = 30;
var RQKEY_ROOT = 'post-quotes';
export var RQKEY = function (resolvedUri) { return [RQKEY_ROOT, resolvedUri]; };
        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.api.app.bsky.feed.getQuotes({
                                uri: resolvedUri || '',
                                limit: PAGE_SIZE,
                                cursor: pageParam,
                            })];
...
export function findAllProfilesInQueryData(queryClient, did) {
    var queryDatas, _i, queryDatas_1, _a, _queryKey, queryData, _b, _c, page, _d, _e, item, quotedPost;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 3:
                ...
                item = _e[_d];
                if (!(item.author.did === did)) return [3 /*break*/, 5];
                return [4 /*yield*/, item.author];
            case 4:
                _f.sent();
                _f.label = 5;
            case 5:
                quotedPost = getEmbeddedPost(item.embed);
...
export function findAllPostsInQueryData(queryClient, uri) {
    var queryDatas, atUri, _i, queryDatas_2, _a, _queryKey, queryData, _b, _c, page, _d, _e, post, quotedPost;
    return __generator(this, function (_f) {
        switch (_f.label) {
            case 0:
                queryDatas = queryClient.getQueriesData({
