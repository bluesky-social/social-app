...
var RQKEY_ROOT = 'my-blocked-accounts';
        ...
        queryFn: function (_a) {
            return __awaiter(this, arguments, void 0, function (_b) {
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0: return [4 /*yield*/, agent.app.bsky.graph.getBlocks({
                                limit: 30,
                                cursor: pageParam,
                            })];
                        case 1:
...
export function findAllProfilesInQueryData(queryClient, did) {
    var queryDatas, _i, queryDatas_1, _a, _queryKey, queryData, _b, _c, page, _d, _e, block;
    return __generator(this, function (_f) {
        switch (_f.label) {
            ...
            case 3:
                ...
                block = _e[_d];
                if (!(block.did === did)) return [3 /*break*/, 5];
