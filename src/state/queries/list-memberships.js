...
export function useListMembershipAddMutation(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, subject = _b.subject, onSuccess = _b.onSuccess, onError = _b.onError;
    var currentAccount = useSession().currentAccount;
    var agent = useAgent();
    ...
    return useMutation({
        ...
        onSuccess: function (data, variables) {
            ...
            if (subject) {
                queryClient.setQueryData(STARTER_PACKS_WITH_MEMBERSHIPS_RKEY(variables.actorDid), function (old) {
                    if (!old)
                        return old;
                    return __assign(__assign({}, old), { pages: old.pages.map(function (page) { return (__assign(__assign({}, page), { starterPacksWithMembership: page.starterPacksWithMembership.map(function (spWithMembership) {
                                var _a, _b, _c, _d;
                                if (spWithMembership.starterPack.list &&
                                    ((_a = spWithMembership.starterPack.list) === null || _a === void 0 ? void 0 : _a.uri) === variables.listUri) {
                                    return __assign(__assign({}, spWithMembership), { starterPack: __assign(__assign({}, spWithMembership.starterPack), { listItemsSample: __spreadArray([
                                                {
                                                    uri: data.uri,
                                                    subject: subject,
                                                }
                                            ], ((_c = (_b = spWithMembership.starterPack.listItemsSample) === null || _b === void 0 ? void 0 : _b.filter(function (item) { return item.subject.did !== variables.actorDid; })) !== null && _c !== void 0 ? _c : []), true), list: __assign(__assign({}, spWithMembership.starterPack.list), { listItemCount: ((_d = spWithMembership.starterPack.list.listItemCount) !== null && _d !== void 0 ? _d : 0) + 1 }) }), listItem: {
                                            uri: data.uri,
                                            subject: subject,
                                        } });
                                }
            ...
            queryClient.setQueryData(STARTER_PACKS_WITH_MEMBERSHIPS_RKEY(variables.actorDid), function (old) {
                ...
                return __assign(__assign({}, old), { pages: old.pages.map(function (page) { return (__assign(__assign({}, page), { starterPacksWithMembership: page.starterPacksWithMembership.map(function (spWithMembership) {
                            ...
                            if (spWithMembership.starterPack.list &&
                                ...
                                return __assign(__assign({}, spWithMembership), { starterPack: __assign(__assign({}, spWithMembership.starterPack), { listItemsSample: (_a = spWithMembership.starterPack.listItemsSample) === null || _a === void 0 ? void 0 : _a.filter(function (item) { return item.subject.did !== variables.actorDid; }), list: __assign(__assign({}, spWithMembership.starterPack.list), { listItemCount: Math.max(0, ((_b = spWithMembership.starterPack.list.listItemCount) !== null && _b !== void 0 ? _b : 1) - 1) }) }), listItem: undefined });
                            }
                            return spWithMembership;
                        }) })); }) });
            });
