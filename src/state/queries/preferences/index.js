...
export var preferencesQueryKey = [PERSISTED_QUERY_ROOT, 'getPreferences'];
export function usePreferencesQuery() {
    ...
    if ((_a = query.data) === null || _a === void 0 ? void 0 : _a.birthDate) {
        /**
...
export function useSetThreadViewPreferencesMutation(_a) {
    var _this = this;
