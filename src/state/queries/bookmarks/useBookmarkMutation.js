...
import { optimisticallyDeleteBookmark, optimisticallySaveBookmark, } from '#/state/queries/bookmarks/useBookmarksQuery';
        ...
        mutationFn: function (args) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(args.action === 'create')) return [3 /*break*/, 2];
                            updatePostShadow(qc, args.post.uri, { bookmarked: true });
                            return [4 /*yield*/, agent.app.bsky.bookmark.createBookmark({
                                    uri: args.post.uri,
                                    cid: args.post.cid,
                                })];
                        case 1:
                            ...
                            return [3 /*break*/, 4];
                        case 2:
                            if (!(args.action === 'delete')) return [3 /*break*/, 4];
                            updatePostShadow(qc, args.uri, { bookmarked: false });
                            return [4 /*yield*/, agent.app.bsky.bookmark.deleteBookmark({
                                    uri: args.uri,
                                })];
                        case 3:
                            _a.sent();
