...
var apiContext = React.createContext({
    ...
    setContentLanguages: function (_) { },
...
export function Provider(_a) {
    ...
    var _b = React.useState(function () { return persisted.get('languagePrefs'); }), state = _b[0], setState = _b[1];
    ...
    var api = React.useMemo(function () { return ({
        ...
        setContentLanguages: function (code2s) {
            setStateWrapped(function (s) { return (__assign(__assign({}, s), { contentLanguages: code2s })); });
        },
        /**
