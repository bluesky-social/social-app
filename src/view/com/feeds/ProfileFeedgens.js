...
export function ProfileFeedgens(_a) {
    var _this = this;
    var _b;
    ...
    var _d = useProfileFeedgensQuery(did, opts), data = _d.data, isPending = _d.isPending, isFetchingNextPage = _d.isFetchingNextPage, hasNextPage = _d.hasNextPage, fetchNextPage = _d.fetchNextPage, isError = _d.isError, error = _d.error, refetch = _d.refetch;
    var isEmpty = !isPending && !((_b = data === null || data === void 0 ? void 0 : data.pages[0]) === null || _b === void 0 ? void 0 : _b.feeds.length);
    ...
    var onRefresh = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    logger.error('Failed to refresh feeds', { message: err_1 });
                    return [3 /*break*/, 4];
                case 4:
                    setIsPTRing(false);
                    return [2 /*return*/];
    ...
    var onEndReached = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_2 = _a.sent();
                    logger.error('Failed to load more feeds', { message: err_2 });
                    return [3 /*break*/, 4];
    ...
    var renderItem = useCallback(function (_a) {
        ...
        if (item === EMPTY) {
            return (_jsx(EmptyState, { style: { width: '100%' }, icon: HashtagWideIcon, message: isSelf
                    ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["You haven't made any custom feeds yet."], ["You haven't made any custom feeds yet."]))))
                    : _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["No custom feeds yet"], ["No custom feeds yet"])))), textStyle: [t.atoms.text_contrast_medium, a.font_medium], button: isSelf
                    ? {
                        label: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Browse custom feeds"], ["Browse custom feeds"])))),
                        text: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Browse custom feeds"], ["Browse custom feeds"])))),
                        onPress: function () { return navigation.navigate('Feeds'); },
                        size: 'small',
                        color: 'secondary',
                    }
                    : undefined }));
    ...
    var ProfileFeedgensFooter = useCallback(function () {
        if (isEmpty)
            return null;
    ...
    return (_jsx(View, { testID: testID, style: style, children: _jsx(List, { testID: testID ? "".concat(testID, "-flatlist") : undefined, ref: scrollElRef, data: items, keyExtractor: keyExtractor, renderItem: renderItem, ListFooterComponent: ProfileFeedgensFooter, refreshing: isPTRing, onRefresh: onRefresh, headerOffset: headerOffset, progressViewOffset: ios(0), removeClippedSubviews: true, desktopFixedHeight: true, onEndReached: onEndReached, contentContainerStyle: { minHeight: height + headerOffset } }) }));
}
