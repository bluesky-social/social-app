...
export function FeedSourceCardLoaded(_a) {
    ...
    if (link) {
        return (_jsx(Link, { testID: "feed-".concat(feed.displayName), label: feed.type === 'feed'
                ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", ", a feed by ", ", liked by ", ""], ["", ", a feed by ", ", liked by ", ""])), feed.displayName, sanitizeHandle(feed.creatorHandle, '@'), feed.likeCount || 0))
                : _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", ", a list by ", ""], ["", ", a list by ", ""])), feed.displayName, sanitizeHandle(feed.creatorHandle, '@'))), to: {
