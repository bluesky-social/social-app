...
function classifyImagePickerAsset(asset) {
    return __awaiter(this, void 0, void 0, function () {
        var mimeType, maybeMimeType, extension, type, bytes, file, isAnimated;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!mimeType) {
                        maybeMimeType = extractDataUriMime(asset.uri);
                        if (maybeMimeType.startsWith('image/') ||
                            ...
                            extension = (_a = asset.uri.split('.').pop()) === null || _a === void 0 ? void 0 : _a.toLowerCase();
                    ...
                    if (!(mimeType === 'image/gif')) return [3 /*break*/, 5];
                    bytes = void 0;
                    if (!IS_WEB) return [3 /*break*/, 2];
                    return [4 /*yield*/, ((_b = asset.file) === null || _b === void 0 ? void 0 : _b.arrayBuffer())];
                case 1:
                    bytes = _c.sent();
                    return [3 /*break*/, 4];
                case 2:
                    file = new File(asset.uri);
                    if (!file.exists) return [3 /*break*/, 4];
                ...
                case 4:
                    if (bytes) {
                        isAnimated = isAnimatedGif(bytes).isAnimated;
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 1:
                    ...
                    asset = assets_2[_i];
                    return [4 /*yield*/, classifyImagePickerAsset(asset)];
                case 2:
                    _c = _d.sent(), success = _c.success, type = _c.type, mimeType = _c.mimeType;
                    if (!success) {
