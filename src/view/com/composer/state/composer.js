...
export function composerReducer(state, action) {
    ...
    switch (action.type) {
        case 'update_postgate': {
            return __assign(__assign({}, state), { thread: __assign(__assign({}, state.thread), { postgate: action.postgate }) });
        }
        case 'update_threadgate': {
            return __assign(__assign({}, state), { thread: __assign(__assign({}, state.thread), { threadgate: action.threadgate }) });
        }
        case 'update_post': {
            ...
            return __assign(__assign({}, state), { thread: __assign(__assign({}, state.thread), { posts: nextPosts }) });
        }
        case 'add_post': {
        ...
        case 'remove_post': {
            ...
            return __assign(__assign({}, state), { activePostIndex: nextActivePostIndex, mutableNeedsFocusActive: true, thread: __assign(__assign({}, state.thread), { posts: nextPosts }) });
        }
        case 'focus_post': {
