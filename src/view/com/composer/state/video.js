...
function getUploadErrorMessage(e, _) {
    ...
    return _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["An error occurred while uploading the video."], ["An error occurred while uploading the video."]))));
}
