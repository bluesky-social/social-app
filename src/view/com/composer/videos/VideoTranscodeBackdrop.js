...
export var RQKEY = 'video-thumbnail';
export function clearThumbnailCache(queryClient) {
    clearCache().catch(function () { });
    void queryClient.resetQueries({ queryKey: [RQKEY] });
}
export function VideoTranscodeBackdrop(_a) {
    var _this = this;
    var uri = _a.uri;
    var thumbnail = useQuery({
        queryKey: [RQKEY, uri],
        queryFn: function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, createVideoThumbnail(uri)];
