...
export function SubtitleFilePicker(_a) {
    ...
    return (_jsxs(View, { style: a.gap_lg, children: [_jsx("input", { type: "file", accept: ".vtt", ref: ref, style: a.hidden, onChange: handlePick, disabled: disabled, "aria-disabled": disabled }), _jsx(View, { style: a.flex_row, children: _jsxs(Button, { onPress: handleClick, label: _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Select caption file (.vtt)"], ["Select caption file (.vtt)"])))), size: "large", color: "primary", variant: "solid", disabled: disabled, children: [_jsx(ButtonIcon, { icon: CCIcon }), _jsx(ButtonText, { children: _jsx(Trans, { children: "Select caption file (.vtt)" }) })] }) })] }));
}
