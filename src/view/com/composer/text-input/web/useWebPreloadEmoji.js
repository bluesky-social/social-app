 ...
 */
export function useWebPreloadEmoji(_a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, immediate = _b.immediate;
    var preload = React.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var data, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, import('./EmojiPickerData.json')];
                case 2:
