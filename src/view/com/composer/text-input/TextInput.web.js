...
export function TextInput(_a) {
    var ref = _a.ref, richtext = _a.richtext, placeholder = _a.placeholder, webForceMinHeight = _a.webForceMinHeight, hasRightPadding = _a.hasRightPadding, isActive = _a.isActive, setRichText = _a.setRichText, onPhotoPasted = _a.onPhotoPasted, onPressPublish = _a.onPressPublish, onNewLink = _a.onNewLink, onFocus = _a.onFocus, autoFocus = _a.autoFocus;
...
function richTextToHTML(richtext) {
    var html = '';
    for (var _i = 0, _a = richtext.segments(); _i < _a.length; _i++) {
        var segment = _a[_i];
        if (segment.mention) {
            html += "<span data-type=\"mention\" data-id=\"".concat(escapeHTML(segment.mention.did), "\"></span>");
        }
        else {
