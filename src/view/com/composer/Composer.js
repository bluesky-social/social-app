...
import { AppBskyDraftCreateDraft, AppBskyUnspeccedDefs, AtUri, } from '@atproto/api';
...
import { loadDraftMedia, useCleanupPublishedDraftMutation, useSaveDraftMutation, } from './drafts/state/queries';
...
export var ComposePost = function (_a) {
    var _b;
    var replyTo = _a.replyTo, onPost = _a.onPost, onPostSuccess = _a.onPostSuccess, initQuote = _a.quote, initMention = _a.mention, openEmojiPicker = _a.openEmojiPicker, initText = _a.text, initImageUris = _a.imageUris, initVideoUri = _a.videoUri, openGallery = _a.openGallery, logContext = _a.logContext, cancelRef = _a.cancelRef;
    ...
    var _c = useSaveDraftMutation(), saveDraft = _c.mutateAsync, _isSavingDraft = _c.isPending;
    var cleanupPublishedDraft = useCleanupPublishedDraftMutation().mutate;
    ...
    var _d = useState(false), isPublishing = _d[0], setIsPublishing = _d[1];
    var _f = useState(''), publishingStage = _f[0], setPublishingStage = _f[1];
     ...
     */
    var _h = useState(null), loadedDraftCreatedAt = _h[0], setLoadedDraftCreatedAt = _h[1];
    /**
     ...
     * stored permanently.
     */
    var _j = useState(null), acceptedLanguageSuggestion = _j[0], setAcceptedLanguageSuggestion = _j[1];
    /**
     * The language(s) of the post being replied to.
     */
    var _k = useState((replyTo === null || replyTo === void 0 ? void 0 : replyTo.langs) || []), replyToLanguages = _k[0], setReplyToLanguages = _k[1];
    /**
    ...
    var _l = useReducer(composerReducer, {
    ...
    }, createComposerState), composerState = _l[0], composerDispatch = _l[1];
    ...
    var allPostsWithinLimit = thread.posts.every(function (post) { return post.richtext.graphemeLength <= MAX_DRAFT_GRAPHEME_LENGTH; });
    ...
    useCallOnce(function () {
        ax.metric('composer:open', {
            logContext: logContext !== null && logContext !== void 0 ? logContext : 'Other',
            isReply: !!replyTo,
            hasQuote: !!initQuote,
            hasDraft: false,
        });
    })();
    var clearVideo = useCallback(function (postId) {
        composerDispatch({
            type: 'update_post',
            postId: postId,
            postAction: {
    ...
    var restoreVideo = useCallback(function (postId, videoInfo) { return __awaiter(void 0, void 0, void 0, function () {
        var asset, response, blob, file, uri, sourceFile, tempFileName, tempFile, abortController, captionTracks_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    asset = void 0;
                    if (!IS_WEB) return [3 /*break*/, 4];
                    return [4 /*yield*/, fetch(videoInfo.uri)];
                case 1:
                    response = _a.sent();
                    return [4 /*yield*/, response.blob()];
                case 2:
                    blob = _a.sent();
                    file = new File([blob], 'restored-video', {
                ...
                case 4:
                    uri = videoInfo.uri;
                    if (IS_ANDROID) {
                        sourceFile = new FileSystem.File(videoInfo.uri);
                        tempFileName = "draft-video-".concat(Date.now(), ".").concat(mimeToExt(videoInfo.mimeType));
                        tempFile = new FileSystem.File(FileSystem.Paths.cache, tempFileName);
                    ...
                    return [4 /*yield*/, getVideoMetadata(uri)];
                case 5:
                    asset = _a.sent();
                    _a.label = 6;
                case 6:
                    ...
                    if (IS_WEB && videoInfo.captions.length > 0) {
                        captionTracks_1 = videoInfo.captions.map(function (c) { return ({
                            lang: c.lang,
                            file: new File([c.content], "caption-".concat(c.lang, ".vtt"), {
                                type: 'text/vtt',
                            }),
                        }); });
                        composerDispatch({
                            ...
                            postAction: {
                                ...
                                videoAction: {
                                    ...
                                    updater: function () { return captionTracks_1; },
                                    signal: abortController.signal,
                                },
                            },
                        });
    ...
    var handleSelectDraft = React.useCallback(function (draftSummary) { return __awaiter(void 0, void 0, void 0, function () {
        var loadedMedia, originalLocalRefs, _a, posts, restoredVideos, draftPosts, draftAgeMs, _i, restoredVideos_1, _b, postIndex, videoInfo, postId;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    return [4 /*yield*/, loadDraftMedia(draftSummary.draft)
                        // Extract original localRefs for orphan detection on save
                    ];
                case 1:
                    loadedMedia = (_c.sent()).loadedMedia;
                    originalLocalRefs = extractLocalRefs(draftSummary.draft);
                    logger.debug('draft loaded', {
                        draftId: draftSummary.id,
                        loadedMediaCount: loadedMedia.size,
                        originalLocalRefCount: originalLocalRefs.size,
                    });
                    return [4 /*yield*/, draftToComposerPosts(draftSummary.draft, loadedMedia)
                        // Dispatch restore action (this also sets draftId in state)
                    ];
                case 2:
                    _a = _c.sent(), posts = _a.posts, restoredVideos = _a.restoredVideos;
                    // Dispatch restore action (this also sets draftId in state)
                    composerDispatch({
                    ...
                    draftPosts = draftSummary.posts;
                    draftAgeMs = Date.now() - new Date(draftSummary.createdAt).getTime();
                    ax.metric('draft:load', {
                        draftAgeMs: draftAgeMs,
                        hasText: draftPosts.some(function (p) { return p.text.trim().length > 0; }),
                        hasImages: draftPosts.some(function (p) { return p.images && p.images.length > 0; }),
                        hasVideo: draftPosts.some(function (p) { return !!p.video; }),
                        hasGif: draftPosts.some(function (p) { return !!p.gif; }),
                    ...
                    for (_i = 0, restoredVideos_1 = restoredVideos; _i < restoredVideos_1.length; _i++) {
                        _b = restoredVideos_1[_i], postIndex = _b[0], videoInfo = _b[1];
    ...
    var _m = useState(false), publishOnUpload = _m[0], setPublishOnUpload = _m[1];
    var onClose = useCallback(function () {
        closeComposer();
        clearThumbnailCache(queryClient);
        revokeAllMediaUrls();
    }, [closeComposer, queryClient]);
    var getDraftSaveError = React.useCallback(function (e) {
        if (e instanceof AppBskyDraftCreateDraft.DraftLimitReachedError) {
            return _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["You've reached the maximum number of drafts"], ["You've reached the maximum number of drafts"]))));
        }
        return _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Failed to save draft"], ["Failed to save draft"]))));
    }, [_]);
    var validateDraftTextOrError = React.useCallback(function () {
        var tooLong = composerState.thread.posts.some(function (post) { return post.richtext.graphemeLength > MAX_DRAFT_GRAPHEME_LENGTH; });
        if (tooLong) {
            setError(_(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["One or more posts are too long to save as a draft. ", ""], ["One or more posts are too long to save as a draft. ", ""])), plural(MAX_DRAFT_GRAPHEME_LENGTH, { one: 'The maximum number of characters is # character.', other: 'The maximum number of characters is # characters.' }))));
            return false;
        }
        return true;
    }, [composerState.thread.posts, _]);
    var handleSaveDraft = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var isNewDraft, result, posts, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setError('');
                ...
                case 2:
                    ...
                    posts = composerState.thread.posts;
                    ax.metric('draft:save', {
                        isNewDraft: isNewDraft,
                        hasText: posts.some(function (p) { return p.richtext.text.trim().length > 0; }),
                        hasImages: posts.some(function (p) { var _a; return ((_a = p.embed.media) === null || _a === void 0 ? void 0 : _a.type) === 'images'; }),
                        hasVideo: posts.some(function (p) { var _a; return ((_a = p.embed.media) === null || _a === void 0 ? void 0 : _a.type) === 'video'; }),
                        hasGif: posts.some(function (p) { var _a; return ((_a = p.embed.media) === null || _a === void 0 ? void 0 : _a.type) === 'gif'; }),
                        hasQuote: posts.some(function (p) { return !!p.embed.quote; }),
                        hasLink: posts.some(function (p) { return !!p.embed.link; }),
                ...
                case 3:
                    e_2 = _a.sent();
                    logger.error('Failed to save draft', { error: e_2 });
                    setError(getDraftSaveError(e_2));
                    return [3 /*break*/, 4];
    ...
    var saveCurrentDraft = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var result, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    e_3 = _a.sent();
                    setError(getDraftSaveError(e_3));
                    return [2 /*return*/, { success: false }];
                case 4: return [2 /*return*/];
            }
        });
    ...
    var handleDiscard = React.useCallback(function () {
        var posts = thread.posts;
        var hasContent = posts.some(function (post) {
    ...
    var isComposerEmpty = React.useMemo(function () {
        // Has multiple posts means it's not empty
        if (thread.posts.length > 1)
            return false;
        var firstPost = thread.posts[0];
        // Has text
        if (firstPost.richtext.text.trim().length > 0)
            return false;
        // Has media
    ...
    var handleClearComposer = React.useCallback(function () {
        composerDispatch({
            type: 'clear',
            initInteractionSettings: preferences === null || preferences === void 0 ? void 0 : preferences.postInteractionSettings,
        });
    }, [composerDispatch, preferences === null || preferences === void 0 ? void 0 : preferences.postInteractionSettings]);
    ...
    var onPressCancel = useCallback(function () {
        ...
        var hasContent = thread.posts.some(function (post) {
            return post.shortenedGraphemeLength > 0 || post.embed.media || post.embed.link;
        });
        ...
        for (var i = 0; i < thread.posts.length; i++) {
            ...
            if (media) {
                if (media.type === 'images' && media.images.some(function (img) { return !img.alt; })) {
                    return _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["One or more images is missing alt text."], ["One or more images is missing alt text."]))));
                }
                if (media.type === 'gif' && !media.alt) {
                    return _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["One or more GIFs is missing alt text."], ["One or more GIFs is missing alt text."]))));
                }
                if (media.type === 'video' &&
                    media.video.status !== 'error' &&
                    !media.video.altText) {
                    return _(msg(templateObject_6 || (templateObject_6 = __makeTemplateObject(["One or more videos is missing alt text."], ["One or more videos is missing alt text."]))));
                }
            }
        }
    ...
    var onPressPublish = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var postUri, postSuccessData, posts, waitErr_1, e_4, err, index, _i, _a, post, draftAgeMs;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 8:
                    ...
                    err = cleanError(e_4.message);
                    if (err.includes('not locate record')) {
                        err = _(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["We're sorry! The post you are replying to has been deleted."], ["We're sorry! The post you are replying to has been deleted."]))));
                    }
                    else if (e_4 instanceof EmbeddingDisabledError) {
                        err = _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["This post's author has disabled quote posts."], ["This post's author has disabled quote posts."]))));
                    }
                    setError(err);
                ...
                case 10:
                    ...
                    if (composerState.draftId && composerState.originalLocalRefs) {
                        ...
                        if (loadedDraftCreatedAt) {
                            draftAgeMs = Date.now() - new Date(loadedDraftCreatedAt).getTime();
                    ...
                    setTimeout(function () {
                        Toast.show(_jsxs(Toast.Outer, { children: [_jsx(Toast.Icon, {}), _jsx(Toast.Text, { children: thread.posts.length > 1
                                        ? _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Your posts were sent"], ["Your posts were sent"]))))
                                        : replyTo
                                            ? _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Your reply was sent"], ["Your reply was sent"]))))
                                            : _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Your post was sent"], ["Your post was sent"])))) }), postUri && (_jsx(Toast.Action, { label: _(msg(templateObject_12 || (templateObject_12 = __makeTemplateObject(["View post"], ["View post"])))), onPress: function () {
    ...
    var _o = useScrollTracker({
        scrollViewRef: scrollViewRef,
        stickyBottom: isLastThreadedPost,
    }), scrollHandler = _o.scrollHandler, onScrollViewContentSizeChange = _o.onScrollViewContentSizeChange, onScrollViewLayout = _o.onScrollViewLayout, topBarAnimatedStyle = _o.topBarAnimatedStyle, bottomBarAnimatedStyle = _o.bottomBarAnimatedStyle;
    ...
    return (_jsx(BottomSheetPortalProvider, { children: _jsxs(KeyboardAvoidingView, { testID: "composePostView", behavior: IS_IOS ? 'padding' : 'height', keyboardVerticalOffset: keyboardVerticalOffset, style: a.flex_1, children: [_jsxs(View, { style: [a.flex_1, viewStyles], "aria-modal": true, accessibilityViewIsModal: true, children: [_jsxs(ComposerTopBar, { canPost: canPost, isReply: !!replyTo, isPublishQueued: publishOnUpload, isPublishing: isPublishing, isThread: thread.posts.length > 1, publishingStage: publishingStage, topBarAnimatedStyle: topBarAnimatedStyle, onCancel: onPressCancel, onPublish: onPressPublish, onSelectDraft: handleSelectDraft, onSaveDraft: saveCurrentDraft, onDiscard: handleClearComposer, isEmpty: isComposerEmpty, isDirty: composerState.isDirty, isEditingDraft: !!composerState.draftId, canSaveDraft: allPostsWithinLimit, textLength: thread.posts[0].richtext.text.length, children: [missingAltError && _jsx(AltTextReminder, { error: missingAltError }), _jsx(ErrorBanner, { error: error, videoState: erroredVideo, clearError: function () { return setError(''); }, clearVideo: erroredVideoPostId
                                    ...
                                    var _a;
                                    return (_jsxs(React.Fragment, { children: [_jsx(ComposerPost, { post: post, dispatch: composerDispatch, textInput: post.id === activePost.id ? textInput : null, isFirstPost: index === 0, isLastPost: index === thread.posts.length - 1, isPartOfThread: thread.posts.length > 1, isReply: index > 0 || !!replyTo, isActive: post.id === activePost.id, canRemovePost: thread.posts.length > 1, canRemoveQuote: index > 0 || !initQuote, onSelectVideo: selectVideo, onClearVideo: clearVideo, onPublish: onComposerPostPublish, onError: setError }), IS_WEBFooterSticky && post.id === activePost.id && (_jsx(View, { style: styles.stickyFooterWeb, children: footer }))] }, post.id + ((_a = composerState.draftId) !== null && _a !== void 0 ? _a : '')));
                                })] }), !IS_WEBFooterSticky && footer] }), replyTo ? (_jsx(Prompt.Basic, { control: discardPromptControl, title: _(msg(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Discard draft?"], ["Discard draft?"])))), description: "", confirmButtonCta: _(msg(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Discard"], ["Discard"])))), confirmButtonColor: "negative", onConfirm: handleDiscard })) : (_jsxs(Prompt.Outer, { control: discardPromptControl, children: [_jsxs(Prompt.Content, { children: [_jsx(Prompt.TitleText, { children: allPostsWithinLimit ? (composerState.draftId ? (_jsx(Trans, { children: "Save changes?" })) : (_jsx(Trans, { children: "Save draft?" }))) : (_jsx(Trans, { children: "Discard post?" })) }), _jsx(Prompt.DescriptionText, { children: allPostsWithinLimit ? (composerState.draftId ? (_jsx(Trans, { children: "You have unsaved changes to this draft, would you like to save them?" })) : (_jsx(Trans, { children: "Would you like to save this as a draft to edit later?" }))) : (_jsx(Trans, { children: "You can only save drafts up to 1000 characters." })) })] }), _jsxs(Prompt.Actions, { children: [allPostsWithinLimit && (_jsx(Prompt.Action, { cta: composerState.draftId
                                        ? _(msg(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Save changes"], ["Save changes"]))))
                                        : _(msg(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Save draft"], ["Save draft"])))), onPress: handleSaveDraft, color: "primary" })), _jsx(Prompt.Action, { cta: _(msg(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Discard"], ["Discard"])))), onPress: handleDiscard, color: "negative_subtle" }), _jsx(Prompt.Cancel, { cta: _(msg(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Keep editing"], ["Keep editing"])))) })] })] }))] }) }));
};
var ComposerPost = React.memo(function ComposerPost(_a) {
    ...
    var selectTextInputPlaceholder = isReply
        ? isFirstPost
            ? _(msg(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Write your reply"], ["Write your reply"]))))
            : _(msg(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Add another post"], ["Add another post"]))))
        : _(msg(templateObject_21 || (templateObject_21 = __makeTemplateObject(["What's up?"], ["What's up?"]))));
    var discardPromptControl = Prompt.usePromptControl();
            ...
            switch (_c.label) {
                case 0:
                    ...
                    if (!SUPPORTED_MIME_TYPES.includes(mimeType_1)) {
                        Toast.show(_(msg(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Unsupported video type: ", ""], ["Unsupported video type: ", ""])), mimeType_1)), {
                            type: 'error',
                        });
                        return [2 /*return*/];
                    }
    ...
    return (_jsxs(View, { style: [
            ...
            isTextOnly && isLastPost && IS_NATIVE && a.flex_grow,
                        ...
                        }, onPhotoPasted: onPhotoPasted, onNewLink: onNewLink, onError: onError, onPressPublish: onPublish, accessible: true, accessibilityLabel: _(msg(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Write post"], ["Write post"])))), accessibilityHint: _(msg(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Compose posts up to ", " in length"], ["Compose posts up to ", " in length"])), plural(MAX_GRAPHEME_LENGTH || 0, {
                            other: '# characters',
                        }))) })] }), canRemovePost && isActive && (_jsxs(_Fragment, { children: [_jsx(Button, { label: _(msg(templateObject_25 || (templateObject_25 = __makeTemplateObject(["Delete post"], ["Delete post"])))), size: "small", color: "secondary", variant: "ghost", shape: "round", style: [a.absolute, { top: 0, right: 0 }], onPress: function () {
                        ...
                        }, children: _jsx(ButtonIcon, { icon: XIcon }) }), _jsx(Prompt.Basic, { control: discardPromptControl, title: _(msg(templateObject_26 || (templateObject_26 = __makeTemplateObject(["Discard post?"], ["Discard post?"])))), description: _(msg(templateObject_27 || (templateObject_27 = __makeTemplateObject(["Are you sure you'd like to discard this post?"], ["Are you sure you'd like to discard this post?"])))), onConfirm: function () {
                            dispatch({
                                type: 'remove_post',
                                postId: post.id,
                            });
                        }, confirmButtonCta: _(msg(templateObject_28 || (templateObject_28 = __makeTemplateObject(["Discard"], ["Discard"])))), confirmButtonColor: "negative" })] })), _jsx(ComposerEmbeds, { canRemoveQuote: canRemoveQuote, embed: post.embed, dispatch: dispatchPost, clearVideo: function () { return onClearVideo(post.id); }, isActivePost: isActive })] }));
});
function ComposerTopBar(_a) {
    var canPost = _a.canPost, isReply = _a.isReply, isPublishQueued = _a.isPublishQueued, isPublishing = _a.isPublishing, isThread = _a.isThread, publishingStage = _a.publishingStage, onCancel = _a.onCancel, onPublish = _a.onPublish, onSelectDraft = _a.onSelectDraft, onSaveDraft = _a.onSaveDraft, onDiscard = _a.onDiscard, isEmpty = _a.isEmpty, isDirty = _a.isDirty, isEditingDraft = _a.isEditingDraft, canSaveDraft = _a.canSaveDraft, textLength = _a.textLength, topBarAnimatedStyle = _a.topBarAnimatedStyle, children = _a.children;
    var t = useTheme();
    var _ = useLingui()._;
    return (_jsxs(Animated.View, { style: topBarAnimatedStyle, layout: native(LinearTransition), children: [_jsxs(View, { style: [
                    a.flex_row,
                    a.align_center,
                    a.gap_xs,
                    IS_LIQUID_GLASS ? [a.px_lg, a.pt_lg, a.pb_md] : [a.p_sm],
                ], children: [_jsx(Button, { label: _(msg(templateObject_29 || (templateObject_29 = __makeTemplateObject(["Cancel"], ["Cancel"])))), variant: "ghost", color: "primary", shape: "default", size: "small", style: [{ paddingLeft: 7, paddingRight: 7 }], hoverStyle: [a.bg_transparent, { opacity: 0.5 }], onPress: onCancel, accessibilityHint: _(msg(templateObject_30 || (templateObject_30 = __makeTemplateObject(["Closes post composer and discards post draft"], ["Closes post composer and discards post draft"])))), children: _jsx(ButtonText, { style: [a.text_md], children: _jsx(Trans, { children: "Cancel" }) }) }), _jsx(View, { style: a.flex_1 }), isPublishing ? (_jsxs(_Fragment, { children: [_jsx(Text, { style: [t.atoms.text_contrast_medium], children: publishingStage }), _jsx(View, { style: styles.postBtn, children: _jsx(ActivityIndicator, {}) })] })) : (_jsxs(_Fragment, { children: [!isReply && (_jsx(DraftsButton, { onSelectDraft: onSelectDraft, onSaveDraft: onSaveDraft, onDiscard: onDiscard, isEmpty: isEmpty, isDirty: isDirty, isEditingDraft: isEditingDraft, canSaveDraft: canSaveDraft, textLength: textLength })), _jsx(Button, { testID: "composerPublishBtn", label: isReply
                                    ? isThread
                                        ? _(msg({
                                    ...
                                    : isThread
                                        ...
                                        })), color: "primary", size: "small", onPress: onPublish, disabled: !canPost || isPublishQueued, children: _jsx(ButtonText, { style: [a.text_md], children: isReply ? (_jsx(Trans, { context: "action", children: "Reply" })) : isThread ? (_jsx(Trans, { context: "action", children: "Post All" })) : (_jsx(Trans, { context: "action", children: "Post" })) }) })] }))] }), children] }));
}
function AltTextReminder(_a) {
    var error = _a.error;
    return (_jsx(Admonition, { type: "error", style: [a.mt_2xs, a.mb_sm, a.mx_lg], children: error }));
}
function ComposerEmbeds(_a) {
    ...
    return (_jsxs(_Fragment, { children: [((_c = embed.media) === null || _c === void 0 ? void 0 : _c.type) === 'images' && (_jsx(Gallery, { images: embed.media.images, dispatch: dispatch })), ((_d = embed.media) === null || _d === void 0 ? void 0 : _d.type) === 'gif' && (_jsxs(View, { style: [a.relative, a.mt_lg], children: [_jsx(ExternalEmbedGif, { gif: embed.media.gif, onRemove: function () { return dispatch({ type: 'embed_remove_gif' }); } }), _jsx(GifAltTextDialog, { gif: embed.media.gif, altText: (_f = embed.media.alt) !== null && _f !== void 0 ? _f : '', onSubmit: function (altText) {
                            ...
                            } })] })) }), ((_g = embed.quote) === null || _g === void 0 ? void 0 : _g.uri) ? (_jsx(View, { style: [a.pb_sm, video ? [a.pt_md] : [a.pt_xl], IS_WEB && [a.pb_md]], children: _jsxs(View, { style: [a.relative], children: [_jsx(LazyQuoteEmbed, { uri: embed.quote.uri, linkDisabled: true }), canRemoveQuote && (_jsx(ExternalEmbedRemoveBtn, { onRemove: function () { return dispatch({ type: 'embed_remove_quote' }); }, style: { top: 16 } }))] }) })) : null] }));
}
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        selectedImages_1.push(composerImage);
                                        return [2 /*return*/];
                                }
                            });
                        }); })).catch(function (e) {
...
function ErrorBanner(_a) {
    ...
    return (_jsx(Animated.View, { style: [a.px_lg, a.pb_sm], entering: FadeIn, exiting: FadeOut, children: _jsxs(View, { style: [
            ...
            ], children: [_jsxs(View, { style: [a.relative, a.flex_row, a.gap_sm, { paddingRight: 48 }], children: [_jsx(CircleInfoIcon, { fill: t.palette.negative_400 }), _jsx(Text, { style: [a.flex_1, a.leading_snug, { paddingTop: 1 }], children: error }), _jsx(Button, { label: _(msg(templateObject_34 || (templateObject_34 = __makeTemplateObject(["Dismiss error"], ["Dismiss error"])))), size: "tiny", color: "secondary", variant: "ghost", shape: "round", style: [a.absolute, { top: 0, right: 0 }], onPress: onClearError, children: _jsx(ButtonIcon, { icon: XIcon }) })] }), videoError && videoState.jobId && (_jsx(Text, { style: [
                        { paddingLeft: 28 },
                        a.text_xs,
                        a.font_semi_bold,
                        a.leading_snug,
...
function VideoUploadToolbar(_a) {
    ...
    var text = '';
    var isGif = ((_b = state.video) === null || _b === void 0 ? void 0 : _b.mimeType) === 'image/gif';
    switch (state.status) {
        case 'compressing':
            if (isGif) {
                text = _(msg(templateObject_35 || (templateObject_35 = __makeTemplateObject(["Compressing GIF..."], ["Compressing GIF..."]))));
            }
            else {
                text = _(msg(templateObject_36 || (templateObject_36 = __makeTemplateObject(["Compressing video..."], ["Compressing video..."]))));
            }
            break;
        case 'uploading':
            if (isGif) {
                text = _(msg(templateObject_37 || (templateObject_37 = __makeTemplateObject(["Uploading GIF..."], ["Uploading GIF..."]))));
            }
            else {
                text = _(msg(templateObject_38 || (templateObject_38 = __makeTemplateObject(["Uploading video..."], ["Uploading video..."]))));
            }
            break;
        case 'processing':
            if (isGif) {
                text = _(msg(templateObject_39 || (templateObject_39 = __makeTemplateObject(["Processing GIF..."], ["Processing GIF..."]))));
            }
            else {
                text = _(msg(templateObject_40 || (templateObject_40 = __makeTemplateObject(["Processing video..."], ["Processing video..."]))));
            }
            break;
        case 'error':
            text = _(msg(templateObject_41 || (templateObject_41 = __makeTemplateObject(["Error"], ["Error"]))));
            wheelProgress = 100;
            break;
        case 'done':
            if (isGif) {
                text = _(msg(templateObject_42 || (templateObject_42 = __makeTemplateObject(["GIF uploaded"], ["GIF uploaded"]))));
            }
            else {
                text = _(msg(templateObject_43 || (templateObject_43 = __makeTemplateObject(["Video uploaded"], ["Video uploaded"]))));
            }
            break;
    }
    return (_jsxs(ToolbarWrapper, { style: [a.flex_row, a.align_center, { paddingVertical: 5 }], children: [_jsx(Animated.View, { style: [animatedStyle], children: _jsx(ProgressCircle, { size: 30, borderWidth: 1, borderColor: t.atoms.border_contrast_low.borderColor, color: state.status === 'error'
                        ...
                        : t.palette.primary_500, progress: wheelProgress }) }), _jsx(Text, { style: [a.font_semi_bold, a.ml_sm], children: text })] }));
}
