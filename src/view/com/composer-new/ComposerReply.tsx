...
export let ComposerReply = ({
  reply,
}: {
  reply: ComposerOptsPostRef
}): React.ReactNode => {
  ...
  return (
    <Pressable
      ...
      <UserAvatar
        ...
        moderation={reply.moderation?.ui('avatar')}
        type={reply.author.associated?.labeler ? 'labeler' : 'user'}
      />

      <View style={styles.replyToPost}>
        <Text type="xl-medium" style={[pal.text]}>
          {sanitizeDisplayName(
            reply.author.displayName || sanitizeHandle(reply.author.handle),
          )}
        </Text>
        <View style={styles.replyToBody}>
          ...
          {images && !reply.moderation?.ui('contentMedia').blur && (
...
ComposerReply = React.memo(ComposerReply)
