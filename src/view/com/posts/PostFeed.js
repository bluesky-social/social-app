...
var PostFeed = function (_a) {
    ...
    var isScrolledDownRef = useRef(false);
    var handleScrolledDownChange = function (isScrolledDown) {
        isScrolledDownRef.current = isScrolledDown;
        onScrolledDownChange === null || onScrolledDownChange === void 0 ? void 0 : onScrolledDownChange(isScrolledDown);
    };
    ...
    return (_jsx(View, { testID: testID, style: style, children: _jsx(List, { testID: testID ? "".concat(testID, "-flatlist") : undefined, ref: scrollElRef, data: feedItems, keyExtractor: function (item) { return item.key; }, renderItem: renderItem, ListFooterComponent: FeedFooter, ListHeaderComponent: ListHeaderComponent, refreshing: isPTRing, onRefresh: onRefresh, headerOffset: headerOffset, progressViewOffset: progressViewOffset, contentContainerStyle: {
            ...
            }, onScrolledDownChange: handleScrolledDownChange, onEndReached: onEndReached, onEndReachedThreshold: 2, removeClippedSubviews: true, extraData: extraData, desktopFixedHeight: desktopFixedHeightOffset ? desktopFixedHeightOffset : true, initialNumToRender: initialNumToRenderOverride !== null && initialNumToRenderOverride !== void 0 ? initialNumToRenderOverride : initialNumToRender, windowSize: 9, maxToRenderPerBatch: IS_IOS ? 5 : 1, updateCellsBatchingPeriod: 40, onItemSeen: onItemSeen }) }));
};
