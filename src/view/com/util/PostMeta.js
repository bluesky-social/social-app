...
var PostMeta = function (opts) {
    ...
    return (_jsxs(View, { style: [
            ...
            a.z_20,
            opts.style,
        ], children: [opts.showAvatar && (_jsx(View, { style: [a.self_center, a.mr_2xs], children: _jsx(PreviewableUserAvatar, { size: opts.avatarSize || 16, profile: author, moderation: (_a = opts.moderation) === null || _a === void 0 ? void 0 : _a.ui('avatar'), type: ((_b = author.associated) === null || _b === void 0 ? void 0 : _b.labeler) ? 'labeler' : 'user', live: live, hideLiveBadge: true }) })), _jsxs(View, { style: [a.flex_row, a.align_end, a.flex_shrink], children: [_jsx(ProfileHoverCard, { did: author.did, children: _jsxs(View, { style: [a.flex_row, a.align_end, a.flex_shrink], children: [_jsx(WebOnlyInlineLinkText, { emoji: true, numberOfLines: 1, to: profileLink, label: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["View profile"], ["View profile"])))), disableMismatchWarning: true, onPress: onBeforePressAuthor, style: [
                                        a.text_md,
                                        a.font_semi_bold,
                                        t.atoms.text,
                                        a.leading_tight,
                                    ...
                                    ], children: _jsx(VerificationCheck, { width: platform({ android: 13, default: 12 }), verifier: verification.role === 'verifier' }) })), _jsx(WebOnlyInlineLinkText, { emoji: true, numberOfLines: 1, to: profileLink, label: _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["View profile"], ["View profile"])))), disableMismatchWarning: true, disableUnderline: true, onPress: onBeforePressAuthor, style: [
                                        a.text_md,
                            ...
                            return (_jsxs(WebOnlyInlineLinkText, { to: opts.postHref, label: timestampLabel, title: timestampLabel, disableMismatchWarning: true, disableUnderline: true, onPress: onBeforePressPost, style: [
                                    a.pl_xs,
                                    a.text_md,
                                    a.leading_tight,
