...
export function ToggleButton(_a) {
    var testID = _a.testID, _b = _a.type, type = _b === void 0 ? 'default-light' : _b, label = _a.label, isSelected = _a.isSelected, style = _a.style, labelType = _a.labelType, onPress = _a.onPress;
    var theme = useTheme();
    var circleStyle = choose(type, {
        primary: {
    ...
    var circleFillStyle = choose(type, {
        primary: {
    ...
    return (_jsx(Button, { testID: testID, type: type, onPress: onPress, style: style, children: _jsxs(View, { style: styles.outer, children: [_jsx(View, { style: [circleStyle, styles.circle], children: _jsx(View, { style: [
                            circleFillStyle,
                            styles.circleFill,
                            isSelected ? styles.circleFillSelected : undefined,
                        ] }) }), label === '' ? null : (_jsx(Text, { type: labelType || 'button', style: [labelStyle, styles.label], children: label }))] }) }));
}
