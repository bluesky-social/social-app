...
export function EmptyState(_a) {
    ...
    return (_jsxs(View, { testID: testID, style: style, children: [_jsx(View, { style: [
                    ...
                    a.self_center,
                    textStyle,
                ], children: message }), button && (_jsx(View, { style: [a.flex_shrink, a.mt_xl, a.self_center], children: _jsx(Button, __assign({}, button, { children: _jsx(ButtonText, { children: button.text }) })) }))] }));
}
