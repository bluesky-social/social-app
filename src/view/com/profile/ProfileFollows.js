...
export function ProfileFollows(_a) {
    var _this = this;
    var _b;
    var name = _a.name;
    var _ = useLingui()._;
    ...
    var _e = useProfileFollowsQuery(resolvedDid), data = _e.data, isFollowsLoading = _e.isLoading, isFetchingNextPage = _e.isFetchingNextPage, hasNextPage = _e.hasNextPage, fetchNextPage = _e.fetchNextPage, error = _e.error, refetch = _e.refetch;
    var isError = !!resolveError || !!error;
    var isMe = resolvedDid === (currentAccount === null || currentAccount === void 0 ? void 0 : currentAccount.did);
    var follows = React.useMemo(function () {
        if (data === null || data === void 0 ? void 0 : data.pages) {
            return data.pages.flatMap(function (page) { return page.follows; });
        }
        return [];
    }, [data]);
    ...
    }, [ax, (_b = data === null || data === void 0 ? void 0 : data.pages) === null || _b === void 0 ? void 0 : _b.length, resolvedDid, follows.length]);
    var onRefresh = React.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    logger.error('Failed to refresh follows', { error: err_1 });
                    return [3 /*break*/, 4];
                case 4:
                    setIsPTRing(false);
                    return [2 /*return*/];
    ...
    var onEndReached = React.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_2 = _a.sent();
                    logger.error('Failed to load more follows', { error: err_2 });
                    return [3 /*break*/, 4];
    ...
    var onItemSeen = React.useCallback(function (item) {
        ...
        var position = follows.findIndex(function (p) { return p.did === item.did; }) + 1;
        if (position === 0) {
            return;
        }
    ...
    if (follows.length < 1) {
        return (_jsx(ListMaybePlaceholder, { isLoading: isDidLoading || isFollowsLoading, isError: isError, emptyType: "results", emptyMessage: isMe
                ? _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["You are not following anyone yet"], ["You are not following anyone yet"]))))
                : _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["This user isn't following anyone."], ["This user isn't following anyone."])))), errorMessage: cleanError(resolveError || error), onRetry: isError ? refetch : undefined, sideBorders: false, useEmptyState: true, emptyStateIcon: PeopleRemoveIcon, emptyStateButton: {
                label: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["See suggested accounts"], ["See suggested accounts"])))),
                text: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["See suggested accounts"], ["See suggested accounts"])))),
                onPress: onPressFindAccounts,
                size: 'tiny',
                color: 'primary',
            } }));
    }
    return (_jsx(List, { data: follows, renderItem: renderItemWithContext, keyExtractor: keyExtractor, refreshing: isPTRing, onRefresh: onRefresh, onEndReached: onEndReached, onEndReachedThreshold: 4, onItemSeen: onItemSeen, ListHeaderComponent: _jsx(FindContactsBannerNUX, {}), ListFooterComponent: _jsx(ListFooter, { isFetchingNextPage: isFetchingNextPage, error: cleanError(error), onRetry: fetchNextPage }), 
