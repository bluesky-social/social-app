...
function LightboxImage(_a) {
    ...
    var safeFrameDelayedForJSThreadOnly = useSafeAreaFrame();
    var safeInsetsDelayedForJSThreadOnly = useSafeAreaInsets();
    var measureSafeArea = React.useCallback(function () {
        ...
        if (!safeArea) {
            ...
            var frame = safeFrameDelayedForJSThreadOnly;
            var insets = safeInsetsDelayedForJSThreadOnly;
            safeArea = {
