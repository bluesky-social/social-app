...
export function BottomBar(_a) {
    ...
    var _d = useSession(), hasSession = _d.hasSession, currentAccount = _d.currentAccount;
    var t = useTheme();
    var _ = useLingui()._;
    var safeAreaInsets = useSafeAreaInsets();
    var footerHeight = useShellLayout().footerHeight;
    var _e = useNavigationTabState(), isAtHome = _e.isAtHome, isAtSearch = _e.isAtSearch, isAtNotifications = _e.isAtNotifications, isAtMyProfile = _e.isAtMyProfile, isAtMessages = _e.isAtMessages;
    ...
    return (_jsxs(_Fragment, { children: [_jsx(SwitchAccountDialog, { control: accountSwitchControl }), _jsx(Animated.View, { style: [
                    ...
                    footerHeight.set(e.nativeEvent.layout.height);
                }, children: hasSession ? (_jsxs(_Fragment, { children: [_jsx(Btn, { testID: "bottomBarHomeBtn", icon: isAtHome ? (_jsx(HomeFilled, { width: iconWidth + 1, style: [styles.ctrlIcon, t.atoms.text, styles.homeIcon] })) : (_jsx(Home, { width: iconWidth + 1, style: [styles.ctrlIcon, t.atoms.text, styles.homeIcon] })), onPress: onPressHome, accessibilityRole: "tab", accessibilityLabel: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Home"], ["Home"])))), accessibilityHint: "" }), _jsx(Btn, { icon: isAtSearch ? (_jsx(MagnifyingGlassFilled, { width: iconWidth + 2, style: [styles.ctrlIcon, t.atoms.text, styles.searchIcon] })) : (_jsx(MagnifyingGlass, { testID: "bottomBarSearchBtn", width: iconWidth + 2, style: [styles.ctrlIcon, t.atoms.text, styles.searchIcon] })), onPress: onPressSearch, accessibilityRole: "search", accessibilityLabel: _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Search"], ["Search"])))), accessibilityHint: "" }), _jsx(Btn, { testID: "bottomBarMessagesBtn", icon: isAtMessages ? (_jsx(MessageFilled, { width: iconWidth - 1, style: [styles.ctrlIcon, t.atoms.text, styles.feedsIcon] })) : (_jsx(Message, { width: iconWidth - 1, style: [styles.ctrlIcon, t.atoms.text, styles.feedsIcon] })), onPress: onPressMessages, notificationCount: numUnreadMessages.numUnread, hasNew: numUnreadMessages.hasNew, accessible: true, accessibilityRole: "tab", accessibilityLabel: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Chat"], ["Chat"])))), accessibilityHint: numUnreadMessages.count > 0
                                ? _(plural((_b = numUnreadMessages.numUnread) !== null && _b !== void 0 ? _b : 0, {
                                    one: '# unread item',
                                    other: '# unread items',
                                }))
                                : '' }), _jsx(Btn, { testID: "bottomBarNotificationsBtn", icon: isAtNotifications ? (_jsx(BellFilled, { width: iconWidth, style: [styles.ctrlIcon, t.atoms.text, styles.bellIcon] })) : (_jsx(Bell, { width: iconWidth, style: [styles.ctrlIcon, t.atoms.text, styles.bellIcon] })), onPress: onPressNotifications, notificationCount: numUnreadNotifications, accessible: true, accessibilityRole: "tab", accessibilityLabel: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Notifications"], ["Notifications"])))), accessibilityHint: numUnreadNotifications === ''
                                ? ''
                                : _(plural(numUnreadNotifications !== null && numUnreadNotifications !== void 0 ? numUnreadNotifications : 0, {
                                    one: '# unread item',
                                    other: '# unread items',
                                })) }), _jsx(Btn, { testID: "bottomBarProfileBtn", icon: _jsx(View, { style: styles.ctrlIconSizingWrapper, children: _jsx(View, { style: [
                                        styles.ctrlIcon,
                                        styles.profileIcon,
                                        isAtMyProfile && [
                                            styles.onProfile,
                                    ...
                                    ], children: _jsx(UserAvatar, { avatar: demoMode ? BOTTOM_BAR_AVI : profile === null || profile === void 0 ? void 0 : profile.avatar, size: iconWidth - (isAtMyProfile ? 3 : 2), 
                                        // See https://github.com/bluesky-social/social-app/pull/1801:
                                        usePlainRNImage: true, type: ((_c = profile === null || profile === void 0 ? void 0 : profile.associated) === null || _c === void 0 ? void 0 : _c.labeler) ? 'labeler' : 'user', live: live, hideLiveBadge: true }) }) }), onPress: onPressProfile, onLongPress: onLongPressProfile, accessibilityRole: "tab", accessibilityLabel: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Profile"], ["Profile"])))), accessibilityHint: "" })] })) : (_jsx(_Fragment, { children: _jsxs(View, { style: {
                            width: '100%',
                            flexDirection: 'row',
                            alignItems: 'center',
                            ...
                            paddingRight: 6,
                            gap: 8,
                        }, children: [_jsxs(View, { style: { flexDirection: 'row', alignItems: 'center', gap: 8 }, children: [_jsx(Logo, { width: 28 }), _jsx(View, { style: { paddingTop: 4 }, children: _jsx(Logotype, { width: 80, fill: t.atoms.text.color }) })] }), _jsxs(View, { style: [a.flex_row, a.flex_wrap, a.gap_sm], children: [_jsx(Button, { onPress: showCreateAccount, label: _(msg(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Create account"], ["Create account"])))), size: "small", variant: "solid", color: "primary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Create account" }) }) }), _jsx(Button, { onPress: showSignIn, label: _(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Sign in"], ["Sign in"])))), size: "small", variant: "solid", color: "secondary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Sign in" }) }) })] })] }) })) })] }));
}
function Btn(_a) {
