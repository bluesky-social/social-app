...
var NotificationsMenuItem = function (_a) {
    ...
    return (_jsx(MenuItem, { icon: isActive ? (_jsx(BellFilled, { style: [t.atoms.text], width: iconWidth })) : (_jsx(Bell, { style: [t.atoms.text], width: iconWidth })), label: _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Notifications"], ["Notifications"])))), accessibilityHint: numUnreadNotifications === ''
            ? ''
            : _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["", ""], ["", ""])), plural(numUnreadNotifications !== null && numUnreadNotifications !== void 0 ? numUnreadNotifications : 0, {
                one: '# unread item',
                other: '# unread items',
...
var FeedsMenuItem = function (_a) {
    ...
    var _ = useLingui()._;
    var t = useTheme();
    return (_jsx(MenuItem, { icon: isActive ? (_jsx(HashtagFilled, { width: iconWidth, style: [t.atoms.text] })) : (_jsx(Hashtag, { width: iconWidth, style: [t.atoms.text] })), label: _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Feeds"], ["Feeds"])))), bold: isActive, onPress: onPress }));
};
...
var ListsMenuItem = function (_a) {
    ...
    var _ = useLingui()._;
    var t = useTheme();
    return (_jsx(MenuItem, { icon: _jsx(List, { style: [t.atoms.text], width: iconWidth }), label: _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Lists"], ["Lists"])))), onPress: onPress }));
};
...
var ProfileMenuItem = function (_a) {
    ...
    var _ = useLingui()._;
    var t = useTheme();
    return (_jsx(MenuItem, { icon: isActive ? (_jsx(UserCircleFilled, { style: [t.atoms.text], width: iconWidth })) : (_jsx(UserCircle, { style: [t.atoms.text], width: iconWidth })), label: _(msg(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Profile"], ["Profile"])))), onPress: onPress }));
};
...
var SettingsMenuItem = function (_a) {
    ...
    var _ = useLingui()._;
    var t = useTheme();
    return (_jsx(MenuItem, { icon: _jsx(Settings, { style: [t.atoms.text], width: iconWidth }), label: _(msg(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Settings"], ["Settings"])))), onPress: onPress }));
};
...
function ExtraLinks() {
    ...
    return (_jsxs(View, { style: [a.flex_col, a.gap_md, a.flex_wrap], children: [_jsx(InlineLinkText, { style: [a.text_md], label: _(msg(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Terms of Service"], ["Terms of Service"])))), to: "https://bsky.social/about/support/tos", children: _jsx(Trans, { children: "Terms of Service" }) }), _jsx(InlineLinkText, { style: [a.text_md], to: "https://bsky.social/about/support/privacy-policy", label: _(msg(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Privacy Policy"], ["Privacy Policy"])))), children: _jsx(Trans, { children: "Privacy Policy" }) }), kawaii && (_jsx(Text, { style: t.atoms.text_contrast_medium, children: _jsxs(Trans, { children: ["Logo by", ' ', _jsx(InlineLinkText, { style: [a.text_md], to: "/profile/sawaratsuki.bsky.social", label: "@sawaratsuki.bsky.social", children: "@sawaratsuki.bsky.social" })] }) }))] }));
}
