...
function DebugInner(_a) {
    var colorScheme = _a.colorScheme, onToggleColorScheme = _a.onToggleColorScheme;
    var _b = React.useState(0), currentView = _b[0], setCurrentView = _b[1];
    var pal = usePalette('default');
    var _ = useLingui()._;
    var renderItem = function (item) {
        return (_jsxs(View, { children: [_jsx(View, { style: [s.pt10, s.pl10, s.pr10], children: _jsx(ToggleButton, { type: "default-light", onPress: onToggleColorScheme, isSelected: colorScheme === 'dark', label: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Dark mode"], ["Dark mode"])))) }) }), item.currentView === 3 ? (_jsx(NotifsView, {})) : item.currentView === 2 ? (_jsx(ErrorView, {})) : item.currentView === 1 ? (_jsx(ControlsView, {})) : (_jsx(BaseView, {}))] }, "view-".concat(item.currentView)));
    };
    var items = [{ currentView: currentView }];
    return (_jsxs(View, { style: [s.hContentRegion, pal.view], children: [_jsx(ViewHeader, { title: _(msg(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Debug panel"], ["Debug panel"])))) }), _jsx(ViewSelector, { swipeEnabled: true, sections: MAIN_VIEWS, items: items, renderItem: renderItem, onSelectView: setCurrentView })] }));
}
function Heading(_a) {
    var label = _a.label;
    var pal = usePalette('default');
...
function EmptyStateView() {
    var _ = useLingui()._;
    return (_jsx(EmptyState, { icon: HashtagWideIcon, iconSize: "2xl", message: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["This is an empty state"], ["This is an empty state"])))) }));
}
...
function ToggleButtonsView() {
    var defaultPal = usePalette('default');
    var buttonStyles = s.mb5;
    var _a = React.useState(false), isSelected = _a[0], setIsSelected = _a[1];
    var onToggle = function () { return setIsSelected(!isSelected); };
