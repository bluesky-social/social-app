 ...
 * locally running server, see `env.example` for more.
 */
export var APP_CONFIG_DEV_URL = process.env.APP_CONFIG_DEV_URL;
export var APP_CONFIG_PROD_URL = "https://app-config.workers.bsky.app";
export var APP_CONFIG_URL = IS_DEV
    ? (APP_CONFIG_DEV_URL !== null && APP_CONFIG_DEV_URL !== void 0 ? APP_CONFIG_DEV_URL : APP_CONFIG_PROD_URL)
    : APP_CONFIG_PROD_URL;
