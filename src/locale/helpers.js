...
export function getTranslatorLink(text, targetLangCode, sourceLanguage) {
    return "https://translate.google.com/?sl=".concat(sourceLanguage !== null && sourceLanguage !== void 0 ? sourceLanguage : 'auto', "&tl=").concat(targetLangCode, "&text=").concat(encodeURIComponent(text));
}
/**
