...
export function dynamicActivate(locale) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale, dateLocale;
...
export function useLocaleLanguage() {
    ...
    useEffect(function () {
        dynamicActivate(sanitizeAppLanguageSetting(appLanguage)).then(function (locale) {
            setDateLocale(locale !== null && locale !== void 0 ? locale : defaultLocale);
        });
    }, [appLanguage]);
    return dateLocale;
}
