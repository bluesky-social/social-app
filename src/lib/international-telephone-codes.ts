...
export const INTERNATIONAL_TELEPHONE_CODES = {
  ...
  AF: {
    name: (i18n: I18n) => i18n._(msg`Afghanistan`),
    code: '+93',
    unicodeFlag: '🇦🇫',
    svgFlag: require('../../assets/icons/flags/AF.svg'),
  },
  AG: {
    name: (i18n: I18n) => i18n._(msg`Antigua and Barbuda`),
    code: '+1268',
    unicodeFlag: '🇦🇬',
    svgFlag: require('../../assets/icons/flags/AG.svg'),
  },
  AI: {
    name: (i18n: I18n) => i18n._(msg`Anguilla`),
    code: '+1264',
    unicodeFlag: '🇦🇮',
    svgFlag: require('../../assets/icons/flags/AI.svg'),
  },
  AL: {
    name: (i18n: I18n) => i18n._(msg`Albania`),
    code: '+355',
    unicodeFlag: '🇦🇱',
    svgFlag: require('../../assets/icons/flags/AL.svg'),
  },
  AM: {
    name: (i18n: I18n) => i18n._(msg`Armenia`),
    code: '+374',
    unicodeFlag: '🇦🇲',
    svgFlag: require('../../assets/icons/flags/AM.svg'),
  },
  AO: {
    name: (i18n: I18n) => i18n._(msg`Angola`),
    code: '+244',
    unicodeFlag: '🇦🇴',
  ...
  GM: {
    name: (i18n: I18n) => i18n._(msg`Gambia`),
    code: '+220',
    unicodeFlag: '🇬🇲',
    svgFlag: require('../../assets/icons/flags/GM.svg'),
  },
  DO: {
    name: (i18n: I18n) => i18n._(msg`Dominican Republic`),
    code: '+1',
    unicodeFlag: '🇩🇴',
    svgFlag: require('../../assets/icons/flags/DO.svg'),
  },
  SD: {
    name: (i18n: I18n) => i18n._(msg`Sudan`),
    code: '+249',
    unicodeFlag: '🇸🇩',
  ...
  CG: {
    name: (i18n: I18n) => i18n._(msg`Republic of the Congo`),
    code: '+242',
    unicodeFlag: '🇨🇬',
    svgFlag: require('../../assets/icons/flags/CG.svg'),
  },
  CZ: {
    name: (i18n: I18n) => i18n._(msg`Czechia`),
    code: '+420',
    unicodeFlag: '🇨🇿',
    svgFlag: require('../../assets/icons/flags/CZ.svg'),
  },
  GB: {
    name: (i18n: I18n) => i18n._(msg`United Kingdom`),
    code: '+44',
    unicodeFlag: '🇬🇧',
    svgFlag: require('../../assets/icons/flags/GB.svg'),
  },
  NE: {
    name: (i18n: I18n) => i18n._(msg`Niger`),
    code: '+227',
    unicodeFlag: '🇳🇪',
    svgFlag: require('../../assets/icons/flags/NE.svg'),
  },
  CD: {
    name: (i18n: I18n) => i18n._(msg`Democratic Republic of the Congo`),
    code: '+243',
    unicodeFlag: '🇨🇩',
    svgFlag: require('../../assets/icons/flags/CD.svg'),
  },
  BS: {
    name: (i18n: I18n) => i18n._(msg`The Bahamas`),
    code: '+1 242',
    unicodeFlag: '🇧🇸',
    svgFlag: require('../../assets/icons/flags/BS.svg'),
  },
  CC: {
    name: (i18n: I18n) => i18n._(msg`Cocos (Keeling) Islands`),
    code: '+61 891',
    unicodeFlag: '🇨🇨',
    svgFlag: require('../../assets/icons/flags/CC.svg'),
  },
  CF: {
    name: (i18n: I18n) => i18n._(msg`Central African Republic`),
    code: '+236',
    unicodeFlag: '🇨🇫',
    svgFlag: require('../../assets/icons/flags/CF.svg'),
  },
  CK: {
    name: (i18n: I18n) => i18n._(msg`Cook Islands`),
    code: '+682',
    unicodeFlag: '🇨🇰',
    svgFlag: require('../../assets/icons/flags/CK.svg'),
  },
  FK: {
    name: (i18n: I18n) => i18n._(msg`Falkland Islands`),
    code: '+500',
    unicodeFlag: '🇫🇰',
    svgFlag: require('../../assets/icons/flags/FK.svg'),
  },
  FO: {
    name: (i18n: I18n) => i18n._(msg`Faroe Islands`),
    code: '+298',
    unicodeFlag: '🇫🇴',
  ...
  KY: {
    name: (i18n: I18n) => i18n._(msg`Cayman Islands`),
    code: '+1 345',
    unicodeFlag: '🇰🇾',
    svgFlag: require('../../assets/icons/flags/KY.svg'),
  },
  MH: {
    name: (i18n: I18n) => i18n._(msg`Marshall Islands`),
    code: '+692',
    unicodeFlag: '🇲🇭',
    svgFlag: require('../../assets/icons/flags/MH.svg'),
  },
  MP: {
    name: (i18n: I18n) => i18n._(msg`Northern Mariana Islands`),
    code: '+1 670',
    unicodeFlag: '🇲🇵',
    svgFlag: require('../../assets/icons/flags/MP.svg'),
  },
  TC: {
    name: (i18n: I18n) => i18n._(msg`Turks and Caicos Islands`),
    code: '+1 649',
    unicodeFlag: '🇹🇨',
  ...
  XK: {
    name: (i18n: I18n) => i18n._(msg`Kosovo`),
    code: '+383',
    unicodeFlag: '🇽🇰',
