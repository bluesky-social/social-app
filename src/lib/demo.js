...
var NOW = new Date();
var POST_1_DATE = subMinutes(NOW, 2).toISOString();
var POST_2_DATE = subMinutes(NOW, 4).toISOString();
var POST_3_DATE = subMinutes(NOW, 5).toISOString();
export var DEMO_FEED = {
    feed: [
        {
            post: {
                ...
                author: {
                    ...
                    viewer: {
                        muted: false,
                        blockedBy: false,
                        following: "at://".concat(DID, "/app.bsky.graph.follow/post1"),
                    },
                    labels: [],
                    ...
                    verification: {
                        verifications: [
                            {
                                issuer: DID,
                                uri: "at://".concat(DID, "/app.bsky.graph.verification/post1"),
                                isValid: true,
            ...
            post: {
                ...
                author: {
                    ...
                    viewer: {
                        muted: false,
                        blockedBy: false,
                        following: "at://".concat(DID, "/app.bsky.graph.follow/post2"),
                    },
                    labels: [],
            ...
            post: {
                ...
                author: {
                    ...
                    viewer: {
                        muted: false,
                        blockedBy: false,
                        following: "at://".concat(DID, "/app.bsky.graph.follow/post3"),
                    },
                    labels: [],
...
export var BOTTOM_BAR_AVI = 'https://bsky.social/about/adi/user_avi.jpg';
