 ...
 */
export var countryCodeToCurrency = {
    ad: 'eur',
    ae: 'aed',
    af: 'afn',
    ag: 'xcd',
...
export function useFormatCurrency(options) {
    ...
    return React.useMemo(function () {
        var locale = deviceLocales.at(0);
        var languageTag = (locale === null || locale === void 0 ? void 0 : locale.languageTag) || appLanguage || 'en-US';
        var countryCode = ((locale === null || locale === void 0 ? void 0 : locale.regionCode) ||
            (geolocation === null || geolocation === void 0 ? void 0 : geolocation.countryCode) ||
            'us').toLowerCase();
        var currency = countryCodeToCurrency[countryCode] || 'usd';
        var format = new Intl.NumberFormat(languageTag, __assign(__assign({}, (options || {})), { style: 'currency', currency: currency })).format;
        return {
            format: format,
            currency: currency,
