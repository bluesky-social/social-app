...
export function MagnifyingGlassIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 2 : _b, _c = _a.color, color = _c === void 0 ? 'currentColor' : _c;
    return (_jsx(Svg, { fill: "none", viewBox: "0 0 24 24", strokeWidth: strokeWidth, stroke: color, width: size || 24, height: size || 24, style: style, children: _jsx(Path, { strokeLinecap: "round", strokeLinejoin: "round", d: "M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" }) }));
}
export function MagnifyingGlassIcon2(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 2 : _b;
    return (_jsxs(Svg, { fill: "none", viewBox: "0 0 24 24", strokeWidth: strokeWidth, stroke: "currentColor", width: size || 24, height: size || 24, style: style, children: [_jsx(Ellipse, { cx: "12", cy: "10.5", rx: "9", ry: "9" }), _jsx(Line, { x1: "18.5", y1: "17", x2: "22", y2: "20.5", strokeLinecap: "round" })] }));
}
export function CogIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.5 : _b;
    return (_jsxs(Svg, { fill: "none", viewBox: "0 0 24 24", width: size || 32, height: size || 32, strokeWidth: strokeWidth, stroke: "currentColor", style: style, children: [_jsx(Path, { strokeLinecap: "round", strokeLinejoin: "round", d: "M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z" }), _jsx(Path, { strokeLinecap: "round", strokeLinejoin: "round", d: "M15 12a3 3 0 11-6 0 3 3 0 016 0z" })] }));
}
// Copyright (c) 2020 Refactoring UI Inc.
// https://github.com/tailwindlabs/heroicons/blob/master/LICENSE
export function UserGroupIcon(_a) {
...
export function SquareIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.3 : _b;
    return (_jsx(Svg, { fill: "none", viewBox: "0 0 24 24", strokeWidth: strokeWidth || 1, stroke: "currentColor", width: size || 24, height: size || 24, style: style, children: _jsx(Rect, { x: "6", y: "6", width: "12", height: "12", strokeLinejoin: "round" }) }));
}
export function RectWideIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.3 : _b;
    return (_jsx(Svg, { fill: "none", viewBox: "0 0 24 24", strokeWidth: strokeWidth || 1, stroke: "currentColor", width: size || 24, height: size || 24, style: style, children: _jsx(Rect, { x: "4", y: "6", width: "16", height: "12", strokeLinejoin: "round" }) }));
}
export function RectTallIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.3 : _b;
    return (_jsx(Svg, { fill: "none", viewBox: "0 0 24 24", strokeWidth: strokeWidth || 1, stroke: "currentColor", width: size || 24, height: size || 24, style: style, children: _jsx(Rect, { x: "6", y: "4", width: "12", height: "16", strokeLinejoin: "round" }) }));
}
export function ComposeIcon2(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.5 : _b;
    return (_jsxs(Svg, { viewBox: "0 0 24 24", stroke: "currentColor", fill: "none", width: size || 24, height: size || 24, style: style, children: [_jsx(Path, { d: "M 20 9 L 20 16 C 20 18.209 18.209 20 16 20 L 8 20 C 5.791 20 4 18.209 4 16 L 4 8 C 4 5.791 5.791 4 8 4 L 15 4", strokeWidth: strokeWidth }), _jsx(Line, { strokeLinecap: "round", x1: "10", y1: "14", x2: "18.5", y2: "5.5", strokeWidth: strokeWidth * 1.5 }), _jsx(Line, { strokeLinecap: "round", x1: "20.5", y1: "3.5", x2: "21", y2: "3", strokeWidth: strokeWidth * 1.5 })] }));
}
export function InfoCircleIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.5 : _b;
...
export function HashtagIcon(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.5 : _b;
    return (_jsxs(Svg, { fill: "none", stroke: "currentColor", viewBox: "0 0 30 30", strokeWidth: strokeWidth, width: size, height: size, style: style, children: [_jsx(Path, { d: "M2 10H28", strokeLinecap: "round" }), _jsx(Path, { d: "M2 20H28", strokeLinecap: "round" }), _jsx(Path, { d: "M11 3L9 27", strokeLinecap: "round" }), _jsx(Path, { d: "M21 3L19 27", strokeLinecap: "round" })] }));
}
// Copyright (c) 2020 Refactoring UI Inc.
// https://github.com/tailwindlabs/heroicons/blob/master/LICENSE
export function ShieldExclamation(_a) {
    var style = _a.style, size = _a.size, _b = _a.strokeWidth, strokeWidth = _b === void 0 ? 1.5 : _b;
