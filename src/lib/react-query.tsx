...
function createGlobalQueryClient() {
...
let __globalQueryClient = createGlobalQueryClient()

export function getGlobalQueryClient() {
  return __globalQueryClient
}

type Context = {
  resetGlobalQueryClient(): void
}
...
export function useResetGlobalQueryClient() {
...
export function GlobalQueryClientProvider({
  ...
  const [queryClient, setQueryClient] = React.useState(() =>
    createGlobalQueryClient(),
  )
  const context = React.useMemo<Context>(() => {
    return {
      resetGlobalQueryClient() {
        logger.debug(`react query: setting new global query client`)
        const client = createGlobalQueryClient()
        __globalQueryClient = client
