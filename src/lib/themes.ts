...
export const darkTheme: Theme = {
  ...
  palette: {
    ...
    default: {
      ...
      borderDark: darkPalette.contrast_300,
      icon: darkPalette.contrast_500,

      // non-standard
      textVeryLight: darkPalette.contrast_400,
      replyLine: darkPalette.contrast_300,
      replyLineDot: darkPalette.contrast_300,
...
export const dimTheme: Theme = {
  ...
  palette: {
    ...
    default: {
      ...
      borderDark: dimPalette.contrast_300,
      icon: dimPalette.contrast_500,

      // non-standard
      textVeryLight: dimPalette.contrast_400,
      replyLine: dimPalette.contrast_300,
      replyLineDot: dimPalette.contrast_300,
