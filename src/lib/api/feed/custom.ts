import {
  ...
  type AppGndrFeedGetFeed as GetCustomFeed,
  GndrAgent,
  jsonStringToLex,
...
async function loggedOutFetch({
   ...
   * @see https://github.com/gander-social/gander-social-atproto/blob/60df3fc652b00cdff71dd9235d98a7a4bb828f05/packages/api/src/agent.ts#L120
   */
