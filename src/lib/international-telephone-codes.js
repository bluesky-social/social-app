 ...
 */
export var INTERNATIONAL_TELEPHONE_CODES = {
    AD: {
        code: '+376',
        unicodeFlag: '🇦🇩',
...
var DEFAULT_PHONE_COUNTRY = 'US';
export function getDefaultCountry(location) {
    var _a;
    var locationCountryCode = (_a = location === null || location === void 0 ? void 0 : location.countryCode) === null || _a === void 0 ? void 0 : _a.toUpperCase();
