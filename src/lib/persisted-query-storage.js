...
function createId(id) {
    return "react-query-cache-".concat(id);
}
/**
 ...
 */
export function createPersistedQueryStorage(id) {
    var _this = this;
    var store = createArchiveDB({ id: createId(id) });
    return {
        ...
        setItem: function (key, value) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, store.set(key, value)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        removeItem: function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, store.delete(key)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
export function clearPersistedQueryStorage(id) {
    return __awaiter(this, void 0, void 0, function () {
        var store;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    store = createArchiveDB({ id: createId(id) });
