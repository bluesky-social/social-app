...
var ProfileHeaderShell = function (_a) {
            ...
            images: [
                {
                    ...
                    thumbUri: uri,
                    thumbRect: thumbRect,
                    dimensions: type === 'circle-avi' || type === 'rect-avi'
                        ? {
    ...
    var onPressAvi = useCallback(function () {
        ...
        if (live.isActive) {
            ...
            var type_1 = ((_a = profile.associated) === null || _a === void 0 ? void 0 : _a.labeler) ? 'rect-avi' : 'circle-avi';
            if (avatar_1 && !(modui.blur && modui.noOverride)) {
                runOnUI(function () {
                    'worklet';
                    var rect = measure(aviRef);
                    runOnJS(_openLightbox)(avatar_1, rect, type_1);
                })();
            }
        }
    }, [
