...
var ProfileHeaderStandard = function (_a) {
    ...
    var profileUnshadowed = _a.profile, descriptionRT = _a.descriptionRT, moderationOpts = _a.moderationOpts, _h = _a.hideBackButton, hideBackButton = _h === void 0 ? false : _h, isPlaceholderProfile = _a.isPlaceholderProfile;
    var t = useTheme();
    ...
    var _j = useProfileBlockMutationQueue(profile), queueUnblock = _j[1];
    var unblockPromptControl = Prompt.usePromptControl();
    var _k = useState(false), showSuggestedFollows = _k[0], setShowSuggestedFollows = _k[1];
...
export function HeaderStandardButtons(_a) {
    ...
    return (_jsxs(_Fragment, { children: [isMe ? (_jsxs(_Fragment, { children: [_jsx(Button, { testID: "profileHeaderEditProfileButton", size: "small", color: "secondary", onPress: function () {
                            playHaptic('Light');
                            editProfileControl.open();
                        }, label: _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Edit profile"], ["Edit profile"])))), children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Edit Profile" }) }) }), _jsx(EditProfileDialog, { profile: profile, control: editProfileControl })] })) : ((_b = profile.viewer) === null || _b === void 0 ? void 0 : _b.blocking) ? (((_c = profile.viewer) === null || _c === void 0 ? void 0 : _c.blockingByList) ? null : (_jsx(Button, { testID: "unblockBtn", size: "small", color: "secondary", label: _(msg(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Unblock"], ["Unblock"])))), disabled: !hasSession, onPress: function () { return unblockPromptControl.open(); }, children: _jsx(ButtonText, { children: _jsx(Trans, { context: "action", children: "Unblock" }) }) }))) : !((_d = profile.viewer) === null || _d === void 0 ? void 0 : _d.blockedBy) ? (_jsxs(_Fragment, { children: [hasSession && (!minimal || ((_e = profile.viewer) === null || _e === void 0 ? void 0 : _e.following)) && (_jsxs(_Fragment, { children: [subscriptionsAllowed && (_jsx(SubscribeProfileButton, { profile: profile, moderationOpts: moderationOpts, disableHint: minimal })), _jsx(MessageProfileButton, { profile: profile })] })), (!minimal || !((_f = profile.viewer) === null || _f === void 0 ? void 0 : _f.following)) && (_jsxs(Button, { testID: ((_g = profile.viewer) === null || _g === void 0 ? void 0 : _g.following) ? 'unfollowBtn' : 'followBtn', size: "small", color: ((_h = profile.viewer) === null || _h === void 0 ? void 0 : _h.following) ? 'secondary' : 'primary', label: ((_j = profile.viewer) === null || _j === void 0 ? void 0 : _j.following)
