...
function ProfileListScreenLoaded(_a) {
    ...
    // modlist only
    var _c = useState(null), headerHeight = _c[0], setHeaderHeight = _c[1];
    ...
    if (isCurateList) {
        return (_jsxs(Hider.Outer, { modui: moderation.ui('contentView'), allowOverride: isOwner, children: [_jsx(Hider.Mask, { children: _jsx(ListHiddenScreen, { list: list, preferences: preferences }) }), _jsxs(Hider.Content, { children: [_jsxs(View, { style: [a.util_screen_outer], children: [_jsxs(PagerWithHeader, { items: sectionTitlesCurate, isHeaderReady: true, renderHeader: renderHeader, onCurrentPageSelected: onCurrentPageSelected, children: [function (_a) {
                                        ...
                                        }] }), _jsx(FAB, { testID: "composeFAB", onPress: function () { return openComposer({ logContext: 'Fab' }); }, icon: _jsx(ComposeIcon2, { strokeWidth: 1.5, size: 29, style: { color: 'white' } }), accessibilityRole: "button", accessibilityLabel: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["New post"], ["New post"])))), accessibilityHint: "" })] }), _jsx(ListAddRemoveUsersDialog, { control: addUserDialogControl, list: list, onChange: onChangeMembers })] })] }));
    }
    return (_jsxs(Hider.Outer, { modui: moderation.ui('contentView'), allowOverride: isOwner, children: [_jsx(Hider.Mask, { children: _jsx(ListHiddenScreen, { list: list, preferences: preferences }) }), _jsxs(Hider.Content, { children: [_jsxs(View, { style: [a.util_screen_outer], children: [_jsx(Layout.Center, { onLayout: function (evt) { return setHeaderHeight(evt.nativeEvent.layout.height); }, style: [
                                    native([a.absolute, a.z_10, t.atoms.bg]),
                                    a.border_b,
                                    t.atoms.border_contrast_low,
                                ], children: renderHeader() }), headerHeight !== null && (_jsx(AboutSection, { list: list, scrollElRef: scrollElRef, onPressAddUser: addUserDialogControl.open, headerHeight: IS_WEB ? 0 : headerHeight })), _jsx(FAB, { testID: "composeFAB", onPress: function () { return openComposer({ logContext: 'Fab' }); }, icon: _jsx(ComposeIcon2, { strokeWidth: 1.5, size: 29, style: { color: 'white' } }), accessibilityRole: "button", accessibilityLabel: _(msg(templateObject_6 || (templateObject_6 = __makeTemplateObject(["New post"], ["New post"])))), accessibilityHint: "" })] }), _jsx(ListAddRemoveUsersDialog, { control: addUserDialogControl, list: list, onChange: onChangeMembers })] })] }));
}
