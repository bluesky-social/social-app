    ...
    const defaults = [
      {
        ...
        iosImage: () => {
          return require(
            `../../../../assets/app-icons/ios_icon_default_old_light.png`,
          )
        },
        androidImage: () => {
          return require(
            `../../../../assets/app-icons/android_icon_default_old_light.png`,
          )
        },
      },
      {
        ...
        iosImage: () => {
          return require(
            `../../../../assets/app-icons/ios_icon_default_old_dark.png`,
          )
        },
        androidImage: () => {
          return require(
            `../../../../assets/app-icons/android_icon_default_old_dark.png`,
          )
        },
      },
