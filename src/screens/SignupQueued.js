...
export function SignupQueued() {
    ...
    return (_jsxs(Modal, { visible: true, animationType: native('slide'), presentationStyle: "formSheet", style: [web(a.util_screen_outer)], children: [IS_IOS && _jsx(SystemBars, { style: { statusBar: 'light' } }), _jsx(ScrollView, { style: [a.flex_1, t.atoms.bg], contentContainerStyle: { borderWidth: 0 }, bounces: false, children: _jsx(View, { style: [
                        a.flex_row,
                        a.justify_center,
