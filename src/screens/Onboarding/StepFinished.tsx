...
import { type AppGndrActorProfile, type AppGndrGraphDefs, AppGndrGraphStarterpack, type Un$Typed,  } from '@gander-social-atproto/api'
...
import { DISCOVER_SAVED_FEED, GNDR_APP_ACCOUNT_DID, TIMELINE_SAVED_FEED, VIDEO_SAVED_FEED,  } from '#/lib/constants'
...
export function StepFinished() {
  ...
  return (
    <View style={[a.align_start]}>
      ...
      <DescriptionText>
        <Trans>We hope you have a wonderful time. Remember, Gander is:</Trans>
      </DescriptionText>
