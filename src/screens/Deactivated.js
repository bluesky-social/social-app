...
export function Deactivated() {
    ...
    var _c = useSessionApi(), logoutCurrentAccount = _c.logoutCurrentAccount, resumeSession = _c.resumeSession;
    var agent = useAgent();
    var _d = React.useState(false), pending = _d[0], setPending = _d[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, resumeSession(__assign(__assign({}, account), { active: true, status: undefined }))];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4:
