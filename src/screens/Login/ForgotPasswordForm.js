...
export var ForgotPasswordForm = function (_a) {
    ...
    return (_jsxs(FormContainer, { testID: "forgotPasswordForm", titleText: _jsx(Trans, { children: "Reset password" }), children: [_jsxs(View, { children: [_jsx(TextField.LabelText, { children: _jsx(Trans, { children: "Hosting provider" }) }), _jsx(HostingProvider, { serviceUrl: serviceUrl, onSelectServiceUrl: setServiceUrl, onOpenDialog: onPressSelectService })] }), _jsxs(View, { children: [_jsx(TextField.LabelText, { children: _jsx(Trans, { children: "Email address" }) }), _jsxs(TextField.Root, { children: [_jsx(TextField.Icon, { icon: At }), _jsx(TextField.Input, { testID: "forgotPasswordEmail", label: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["Enter your email address"], ["Enter your email address"])))), autoCapitalize: "none", autoFocus: true, autoCorrect: false, autoComplete: "email", value: email, onChangeText: setEmail, editable: !isProcessing, accessibilityHint: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Sets email for password reset"], ["Sets email for password reset"])))) })] })] }), _jsx(Text, { style: [t.atoms.text_contrast_high, a.leading_snug], children: _jsx(Trans, { children: "Enter the email you used to create your account. We'll send you a \"reset code\" so you can set a new password." }) }), _jsx(FormError, { error: error }), _jsxs(View, { style: [web([a.flex_row, a.align_center]), a.pt_md], children: [IS_WEB && (_jsxs(_Fragment, { children: [_jsx(Button, { label: _(msg(templateObject_5 || (templateObject_5 = __makeTemplateObject(["Back"], ["Back"])))), color: "secondary", size: "large", onPress: onPressBack, children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Back" }) }) }), _jsx(View, { style: a.flex_1 })] })), !serviceDescription ? (_jsxs(Button, { label: _(msg(templateObject_6 || (templateObject_6 = __makeTemplateObject(["Connecting to service..."], ["Connecting to service..."])))), size: "large", color: "secondary", disabled: true, children: [_jsx(ButtonIcon, { icon: Loader }), _jsx(ButtonText, { children: "Connecting..." })] })) : (_jsxs(Button, { label: _(msg(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Next"], ["Next"])))), accessibilityHint: _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Navigates to the next screen"], ["Navigates to the next screen"])))), color: "primary", size: "large", onPress: onPressNext, disabled: isProcessing, children: [_jsx(ButtonText, { children: _jsx(Trans, { children: "Next" }) }), isProcessing && _jsx(ButtonIcon, { icon: Loader })] }))] }), _jsx(View, { style: [
                    ...
                    a.flex_row,
                    a.justify_center,
                ], children: _jsx(Button, { testID: "skipSendEmailButton", onPress: onEmailSent, label: _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Go to next"], ["Go to next"])))), accessibilityHint: _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Navigates to the next screen"], ["Navigates to the next screen"])))), size: "large", variant: "ghost", color: "secondary", children: _jsx(ButtonText, { children: _jsx(Trans, { children: "Already have a code?" }) }) }) })] }));
};
