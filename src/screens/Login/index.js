...
export var Login = function (_a) {
    ...
    switch (currentForm) {
        ...
        case Forms.ChooseAccount:
            ...
            content = (_jsx(ChooseAccountForm, { onSelectAccount: onSelectAccount, onPressBack: goBack }));
            break;
        case Forms.ForgotPassword:
            ...
            goBack = function () { return gotoForm(Forms.Login); };
            content = (_jsx(ForgotPasswordForm, { error: error, serviceUrl: serviceUrl, serviceDescription: serviceDescription, setError: setError, setServiceUrl: setServiceUrl, onPressBack: goBack, onEmailSent: function () { return gotoForm(Forms.SetNewPassword); } }));
            break;
        case Forms.SetNewPassword:
            ...
            goBack = function () { return gotoForm(Forms.ForgotPassword); };
            content = (_jsx(SetNewPasswordForm, { error: error, serviceUrl: serviceUrl, setError: setError, onPressBack: goBack, onPasswordSet: function () { return gotoForm(Forms.PasswordUpdated); } }));
            break;
    ...
    var navigation = goBack ? { goBack: goBack } : null;
    return (_jsx(AuthLayoutNavigationContext, { value: navigation, children: _jsx(Animated.View, { style: a.flex_1, entering: native(FadeIn.duration(90)), children: _jsxs(KeyboardAvoidingView, { testID: "signIn", behavior: "padding", style: a.flex_1, children: [_jsxs(AuthLayout.Header.Outer, { children: [_jsx(AuthLayout.Header.BackButton, {}), _jsx(AuthLayout.Header.Content, {}), _jsx(AuthLayout.Header.Slot, {})] }), _jsx(LoggedOutLayout, { leadin: "", title: title, description: description, scrollable: true, children: _jsx(LayoutAnimationConfig, { skipEntering: true, children: _jsx(ScreenTransition, { direction: screenTransitionDirection, children: content }, currentForm) }) })] }) }) }));
};
