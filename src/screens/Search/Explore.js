...
function LoadMore(_a) {
    ...
    var t = useTheme();
    var _ = useLingui()._;
    return (_jsx(Button, { label: _(msg(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Load more"], ["Load more"])))), onPress: item.onLoadMore, style: [a.relative, a.w_full], children: function (_a) {
...
export function Explore(_a) {
    ...
    var topBorder = useMemo(function () { return ({ type: 'topBorder', key: 'top-border' }); }, []);
    var trendingTopicsModule = useMemo(function () { return ({ type: 'trendingTopics', key: 'trending-topics' }); }, []);
            ...
            if (suggestedFeeds && preferences) {
                ...
                if (feedsError) {
                    i.push({
                        type: 'error',
                        key: 'feedsError',
                        message: _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Failed to load suggested feeds"], ["Failed to load suggested feeds"])))),
                        error: cleanError(feedsError),
                    });
                }
                else if (preferencesError) {
                    i.push({
                        type: 'error',
                        key: 'preferencesError',
                        message: _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Failed to load feeds preferences"], ["Failed to load feeds preferences"])))),
                        error: cleanError(preferencesError),
                    });
                }
                else {
            ...
            if (feeds && preferences) {
                ...
                if (feedsError) {
                    i.push({
                        type: 'error',
                        key: 'feedsError',
                        message: _(msg(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Failed to load suggested feeds"], ["Failed to load suggested feeds"])))),
                        error: cleanError(feedsError),
                    });
                }
                else if (preferencesError) {
                    i.push({
                        type: 'error',
                        key: 'preferencesError',
                        message: _(msg(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Failed to load feeds preferences"], ["Failed to load feeds preferences"])))),
                        error: cleanError(preferencesError),
                    });
                }
                else {
                    ...
                    if (hasNextFeedsPage) {
                        i.push({
                            type: 'loadMore',
                            key: 'loadMoreFeeds',
                            message: _(msg(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Load more suggested feeds"], ["Load more suggested feeds"])))),
                            isLoadingMore: isLoadingMoreFeeds,
                            onLoadMore: onLoadMoreFeeds,
                        });
                    }
                ...
                if (feedsError) {
                    i.push({
                        type: 'error',
                        key: 'feedsError',
                        message: _(msg(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Failed to load suggested feeds"], ["Failed to load suggested feeds"])))),
                        error: cleanError(feedsError),
                    });
                }
                else if (preferencesError) {
                    i.push({
                        type: 'error',
                        key: 'preferencesError',
                        message: _(msg(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Failed to load feeds preferences"], ["Failed to load feeds preferences"])))),
                        error: cleanError(preferencesError),
                    });
                }
                else {
    ...
    var suggestedStarterPacksModule = useMemo(function () {
        ...
        i.push({
            ...
            title: _(msg(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Starter Packs"], ["Starter Packs"])))),
            icon: StarterPack,
            iconSize: 'xl',
        });
    ...
    var renderItem = useCallback(function (_a) {
        ...
        switch (item.type) {
            ...
            case 'preview:loadMoreError': {
                return (_jsx(LoadMoreRetryBtn, { label: _(msg(templateObject_18 || (templateObject_18 = __makeTemplateObject(["There was an issue fetching posts. Tap here to try again."], ["There was an issue fetching posts. Tap here to try again."])))), onPress: fetchNextPageFeedPreviews }));
            }
            case 'interests-card': {
    ...
    return (_jsx(List, { data: items, renderItem: renderItem, keyExtractor: keyExtractor, desktopFixedHeight: true, contentContainerStyle: { paddingBottom: 100 }, keyboardShouldPersistTaps: "handled", keyboardDismissMode: "on-drag", stickyHeaderIndices: native(stickyHeaderIndices), viewabilityConfig: viewabilityConfig, onItemSeen: onItemSeen, onEndReached: onLoadMoreFeedPreviews, 
         ...
         */
        updateCellsBatchingPeriod: 50, refreshing: isPTR, onRefresh: onPTR }));
}
