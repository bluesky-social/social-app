...
var SearchResults = function (_a) {
    ...
    var sections = useMemo(function () {
        ...
        return [
            ...
            noParams && {
                title: _(msg(templateObject_3 || (templateObject_3 = __makeTemplateObject(["People"], ["People"])))),
                component: (_jsx(SearchScreenUserResults, { query: query, active: activeTab === 2 })),
            },
            noParams && {
                title: _(msg(templateObject_4 || (templateObject_4 = __makeTemplateObject(["Feeds"], ["Feeds"])))),
...
var SearchScreenPostResults = function (_a) {
    ...
    return error ? (_jsx(EmptyState, { messageText: _(msg(templateObject_8 || (templateObject_8 = __makeTemplateObject(["We're sorry, but your search could not be completed. Please try again in a few minutes."], ["We're sorry, but your search could not be completed. Please try again in a few minutes."])))), error: cleanError(error) })) : (_jsx(_Fragment, { children: isFetched ? (_jsx(_Fragment, { children: posts.length ? (_jsx(List, { data: items, renderItem: function (_a) {
                ...
                }, keyExtractor: function (item) { return item.key; }, refreshing: isPTR, onRefresh: onPullToRefresh, onEndReached: onEndReached, onItemSeen: function (item) {
                    if (item.type === 'post') {
...
var SearchScreenUserResults = function (_a) {
    ...
    if (error) {
        return (_jsx(EmptyState, { messageText: _(msg(templateObject_9 || (templateObject_9 = __makeTemplateObject(["We're sorry, but your search could not be completed. Please try again in a few minutes."], ["We're sorry, but your search could not be completed. Please try again in a few minutes."])))), error: error.toString() }));
    }
