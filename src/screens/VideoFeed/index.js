...
function PlayPauseTapArea(_a) {
    ...
    return (_jsx(Button, { disabled: !player, "aria-valuetext": isPlaying ? _(msg(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Video is playing"], ["Video is playing"])))) : _(msg(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Video is paused"], ["Video is paused"])))), label: _(msg(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Video from ", ". Tap to play or pause the video"], ["Video from ", ". Tap to play or pause the video"])), sanitizeHandle(post.author.handle, '@'))), accessibilityHint: _(msg(templateObject_13 || (templateObject_13 = __makeTemplateObject(["Double tap to like"], ["Double tap to like"])))), onPress: onPress, style: [a.absolute, a.inset_0, a.z_10], children: _jsx(View, {}) }));
}
function EndMessage() {
    var navigation = useNavigation();
    var _ = useLingui()._;
    ...
    return (_jsxs(View, { style: [
            ...
            { maxWidth: 350 },
                ...
                }, variant: "solid", color: "secondary_inverted", size: "small", label: _(msg(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Go back"], ["Go back"])))), accessibilityHint: _(msg(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Returns to previous page"], ["Returns to previous page"])))), children: [_jsx(ButtonIcon, { icon: ArrowLeftIcon }), _jsx(ButtonText, { children: _jsx(Trans, { children: "Go back" }) })] })] }));
}
/*
