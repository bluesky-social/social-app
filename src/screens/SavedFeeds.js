...
function ListItem(_a) {
    var _this = this;
    var feed = _a.feed, isPinned = _a.isPinned, currentFeeds = _a.currentFeeds, setCurrentFeeds = _a.setCurrentFeeds;
    var _ = useLingui()._;
    var t = useTheme();
    ...
    var onPressUp = function () { return __awaiter(_this, void 0, void 0, function () {
        var nextFeeds, ids, index, nextIndex;
        var _a;
        return __generator(this, function (_b) {
            if (!isPinned)
                return [2 /*return*/];
            nextFeeds = currentFeeds.slice();
            ids = currentFeeds.map(function (f) { return f.id; });
            index = ids.indexOf(feed.id);
            nextIndex = index - 1;
            if (index === -1 || index === 0)
                return [2 /*return*/];
            _a = [
                nextFeeds[nextIndex],
                nextFeeds[index],
            ], nextFeeds[index] = _a[0], nextFeeds[nextIndex] = _a[1];
            setCurrentFeeds(nextFeeds);
            return [2 /*return*/];
        });
    }); };
    var onPressDown = function () { return __awaiter(_this, void 0, void 0, function () {
        var nextFeeds, ids, index, nextIndex;
        var _a;
        return __generator(this, function (_b) {
            if (!isPinned)
            ...
            index = ids.indexOf(feed.id);
            nextIndex = index + 1;
            if (index === -1 || index >= nextFeeds.filter(function (f) { return f.pinned; }).length - 1)
                return [2 /*return*/];
            _a = [
                nextFeeds[nextIndex],
                nextFeeds[index],
    ...
    var onPressRemove = function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            playHaptic();
