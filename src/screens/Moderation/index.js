...
export function ModerationScreenInner(_a) {
    ...
    var _c = usePreferencesSetAdultContentMutation(), setAdultContentPref = _c.mutateAsync, optimisticAdultContent = _c.variables;
