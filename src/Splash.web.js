...
export function Splash(_a) {
    ...
    var _b = useState(false), isAnimationComplete = _b[0], setIsAnimationComplete = _b[1];
    var splashRef = useRef(null);
    ...
    useEffect(function () {
        ...
        animation.onfinish = function () { return setIsAnimationComplete(true); };
        return function () {
            animation.cancel();
        };
    }, [isReady]);
    return (_jsxs(_Fragment, { children: [isReady && children, !isAnimationComplete && (_jsx("div", { ref: splashRef, style: flatten([
                    a.fixed,
                    a.inset_0,
                    a.flex,
                    a.align_center,
