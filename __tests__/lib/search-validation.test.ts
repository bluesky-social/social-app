...
test('Search term and verify results', {tag: '@search'}, async ({ page }) => {
...
test('Search empty term and verify results', {tag: '@search'}, async ({ page }) => {
...
test('Search user and verify results', {tag: '@search'}, async ({ page }) => {
