...
describe('linkRequiresWarning', () => {
  ...
  const cases: Case[] = [
    ...
    ['http://bsky.app/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['https://bsky.app/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['http://bsky.app/', 'bluesky', false],
    ['https://bsky.app/', 'bluesky', false],
    [
      'http://bsky.app/bob.test/post/3kbeuduu7m22v',
      'http://bsky.app/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
      'https://bsky.app/bob.test/post/3kbeuduu7m22v',
      'http://bsky.app/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    ['http://bsky.app/', 'http://bsky.app/bob.test/post/3kbeuduu7m22v', false],
    ['https://bsky.app/', 'http://bsky.app/bob.test/post/3kbeuduu7m22v', false],
    ['http://bsky.app/bob.test/post/3kbeuduu7m22v', 'https://google.com', true],
    [
      'https://bsky.app/bob.test/post/3kbeuduu7m22v',
      'https://google.com',
      true,
