...
var BottomSheetNativeComponent = /** @class */ (function (_super) {
    ...
    BottomSheetNativeComponent.prototype.render = function () {
        ...
        return (_jsx(Portal, { children: _jsx(BottomSheetNativeComponentInner, __assign({}, this.props, { nativeViewRef: this.ref, onStateChange: this.onStateChange, extraStyles: extraStyles, onLayout: IS_IOS15
                    ? function (e) {
