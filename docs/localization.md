...
We want the official Gander app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://gander.crowdin.com/gander-social) or open an issue on the [Gander app repo on GitHub](https://github.com/gander-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - Gander Crowdin: https://gander.crowdin.com/gander-social
...
[Crowdin](https://gander.crowdin.com/gander-social) is our primary tool for managing translations. There are two roles:
...
You can request a new language be added to the project by clicking **Request New Language** on [Crowdin](https://gander.crowdin.com/gander-social) or you can create a [GitHub issue](https://github.com/gander-social/social-app/issues).
