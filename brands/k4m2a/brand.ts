...
const brand: Brand = {
  ...
  pds: {
    ...
    // unless features.allowForeignPdsSignup is also disabled at sign-in.
    serviceUrl: 'https://staging.maanav.net',
    serviceDid: 'did:web:staging.maanav.net',
    // TODO: public appview for read-only profile/feed lookup. Defaults to
    // bluesky's public appview if you haven't stood up your own.
    publicService: 'https://public.api.bsky.app',
    appview: 'https://api.bsky.app',
    appviewDid: 'did:web:api.bsky.app',
  },

  // TODO: the DID of the brand's "official" account (used to identify
  // brand-owned feeds). Often the account that owns your default feed.
  appAccountDid: 'did:plc:TODO',

  defaultFeeds: [
    // First entry: algorithmic discover pin. Second: following timeline.
    // The wider app reads these by index — keep the order.
    {
      type: 'feed',
      // TODO: at:// URI of your community's discover/algorithmic feed
      value: 'at://did:plc:TODO/app.bsky.feed.generator/TODO',
      pinned: true,
    },
    {
      type: 'timeline',
  ...
  links: {
    // TODO: brand-owned support / legal URLs
    helpDesk: 'https://TODO.example.com/help',
    statusPage: 'https://status.TODO.example.com/',
    download: 'https://TODO.example.com/download',
    embedService: 'https://embed.TODO.example.com',
    gifService: 'https://gifs.bsky.app',
    videoService: 'https://video.bsky.app',
    videoServiceDid: 'did:web:video.bsky.app',
    tos: 'https://TODO.example.com/tos',
    privacy: 'https://TODO.example.com/privacy',
    community: 'https://TODO.example.com/community-guidelines',
    communityDeprecated:
      'https://TODO.example.com/community-guidelines-deprecated',
  },

  blogUrls: {
    // TODO: brand blog post URLs surfaced inside the app. Safe to point at a
    // generic landing page if the brand doesn't have these specific posts.
    findFriendsAnnouncement: 'https://TODO.example.com/blog/find-friends',
    initialVerificationAnnouncement:
      'https://TODO.example.com/blog/verification',
    searchTipsAndTricks: 'https://TODO.example.com/blog/search',
    findFriendsPrivacyPolicy:
      'https://TODO.example.com/support/find-friends-privacy',
  },

  features: {
    // Restrict signup to the brand PDS. Sign-in always allows foreign PDS.
    allowForeignPdsSignup: false,
    showStarterPacks: true,
    showLiveNow: true,
  },

  // TODO: replace with hand-tuned palette ramps. DEFAULT_PALETTE is bluesky;
  // you'll get a working app but with bluesky's blue. See
  // `brands/README.md` for guidance.
  palette: {
  ...
  logo: {
    // TODO: replace with brand SVG path data (see `brands/bluesky/brand.ts`
    // for shape). Bluesky placeholders below render the bluesky butterfly.
    mark: {
      viewBox: '0 0 64 57',
      ratio: 57 / 64,
    ...
    // No kawaii easter egg for k4m2a — kawaii toggle will fall back to the
    // regular mark. Add `kawaiiAssets` here if you want a brand-specific
    // raster fallback.
  },
}
